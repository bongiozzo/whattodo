...
[Сергей Довлатов](https://www.livelib.ru/quote/154795-zapovednik-sergej-dovlatov){ .author }
...
## SamLukaBot {#samlukabot}

В сентябре 2017 года, 8 лет назад, самарские СМИ рассказали, что [разработчики национального парка «Самарская Лука»](https://lukaonline.ru/publications/samluka/4059/) запустили [цифровой сервис покупки билетов](https://www.samara.kp.ru/online/news/2862088/) в мессенджере Telegram.

Это было не совсем так :-)

[Тут и в комментариях оригинальная информация](https://vk.com/wall20069794_27), откуда её взяли и переиначили журналисты.

В двух словах, история была такая…

Нас с друзьями чуть не оштрафовали за нахождение на территории национального парка без билета.
Мы шли в кругосветку по Самарской Луке на байдарках и остановились на ночёвку.

Надо отметить, что мы тщательно соблюдали правила бережного отношения к природе и себя чувствовали вполне уверенно.

Но оказалось, что нужно было заранее оформлять бумажные путёвки в самарском офисе национального парка или искать лесника в деревне на окраине, чтобы их купить у него.

Ощущения этого происшествия были не очень приятные и я закусился с инспекторами, утверждая, что процесс посещения национального парка должен быть упрощён.

И по возвращению из похода занялся изучением вопроса.
В конечном итоге познакомился с директором нацпарка и убедил его, что не будет нарушением закона, если я выкуплю 1 000 билетов и сделаю цифровой сервис их продажи через самописного бота в [удобном Telegram](p1-040-unhappiness.md#information_flow).

Со стороны парка заместитель директора — [Ульянов Валерий Юрьевич](https://npsamluka.ru/news/ушел-из-жизни-валерий-ульянов/), всерьёз вложился в эту идею и всячески помогал с запуском сервиса.

Надо было согласовать со всеми сотрудниками, чтобы «картинки» на смартфонах посетителей воспринимались как законные документы!

Это было непросто! :-)

Так появился, возможно, первый в России цифровой сервис федерального уровня для граждан, функционирующий в Telegram :-)

Ведь [национальные парки](https://ru.wikipedia.org/wiki/Список_национальных_парков_России), коих в России насчитывается 70 штук, это федеральные учреждения Министерства Природы Российской Федерации.
А «Самарская Лука» стала первым учреждением такого уровня с простым и удобным цифровым сервисом!

Спустя год начались попытки заблокировать Telegram и мне пришлось перенести бота в ВКонтакте — [SamLukaBot 2.0](https://vk.com/samlukabot).

Заодно добавил функционал выдачи билетов «за счёт заведения», если посетитель присылал фотографии найденного и самостоятельно убранного мусора на территории парка.

Спустя ещё четыре года, в 2022-м, [национальный парк самостоятельно запустил продажу электронных путёвок на своём официальном сайте](https://npsamluka.ru).
...
[Вадим Шефнер](http://a-pesni.org/dvor/piter/a-izzapisn.php){ .author }
...
И вообще этот функционал потока сообщений, фактов и функций мы реализовали в виде [открытого API](https://api.petersburg.ru/mainPortal/api_services;role=22), чтобы вовлекались разработчики и создавали разнообразные информирующие и полезные каналы и сервисы с привязкой к месту города.
...
[Анатолий Рыбаков](https://www.livelib.ru/quote/431589-tyazhelyj-pesok-anatolij-rybakov){ .author }
...
А ещё спустя год после написания предыдущего абзаца порадовался победе проекта в премии Рунета.

![Премия Рунета 2025](img/ilhrunet.jpg){ width="50%", loading=lazy }
/// caption
Премия Рунета 2025
///

Родители согласятся, что успехи детей радуют не меньше, а то и больше, чем собственные.
...
Ещё раньше в Петербурге над идеей счастливого мироустройства размышляли Достоевский, Соловьёв, Рерих, Блаватская…
...
А [Старую Самару](#old_samara) есть идея увековечить, создав модельки домов для 3D принтера.
А инструкции для печати можно раздать всем желающим присоединиться к этой идее.
