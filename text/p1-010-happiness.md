...
И в глубине души мы стремимся к этому образу в течение значительной части своей жизни, если жизни ничто не угрожает.
...
Мне самому после частого использования оно видится чуждым и больше нравится слово «Радость», которое, впрочем, имеет иные ассоциации.

Однако сейчас оно, что называется, «на слуху» и если подумать над собственным восприятием славянского слова «Счастье», то видится образ соприЧастия к чему-то хорошему и большому.
...
Часто звучит цель к стремлению быть в балансе, но если задаться вопросом «Хочется быть преимущественно в Балансе или в Радости?», могу предположить, что Плюс вызывает больше симпатии, чем безжизненный Ноль :-)

Может ли Радости быть больше?
...
![Быть частью большого и светлого мира](img/family_bakery.jpg){ width="100%", loading=lazy }
/// caption
...
Психологами было замечено, что порядка 50% ощущения благополучия или счастья зависит от обстоятельств, на которые мы вообще не сильно влияем.
...
![Доставщик Счастья](img/myosin_render.gif){ width="50%", loading=lazy }
/// caption
Доставщик Счастья
///
...
![Счастье — это большой труд](img/myosin_real.gif){ width="100%", loading=lazy }
/// caption
...
[Мэттью Перри](https://www.livelib.ru/quote/47121569-druzya-lyubimye-i-odna-bolshaya-uzhasnaya-vesch-avtobiografiya-mettyu-perri){ .author }
...
40%, по мнению [Сони Любомирски](https://www.b17.ru/blog/401335/), зависит от системы взглядов, которую мы чаще всего перенимаем от общества.
...
Пожалуй, это основной вывод из другого известного и самого продолжительного психологического исследования — [«Гарвардское исследование взрослых людей с 1938 по 2014 годы»](https://psychosearch.ru/napravleniya/social/882-secret-of-happiness?ysclid=mavy1fsnwm445224018).
...
[Генри Форд](https://www.livelib.ru/quote/47208530-moya-zhizn-moi-dostizheniya-s-sovremennymi-kommentariyami-genri-ford){ .author }
...
[Ирвин Ялом](https://www.livelib.ru/quote/45324397-ekzistentsialnaya-psihoterapiya-irvin-yalom){ .author }
...
![Тайный рецепт Счастья где-то рядом](img/tolstoy_grave.jpg){ width="100%", loading=lazy }
/// caption
...
Что будем делать в четверг, если умрём в среду?

[Пётр Мамонов](https://www.pravmir.ru/petr-mamonov-chto-budem-delat-v-chetverg-esli-umrem-v-sredu-video/){ .author }

///

Но запуск этих мыслительных процессов о смерти, её осознание и начало планирования оказались для меня чрезвычайно полезны.
...
И потом в дополнение посмотреть часовой [фильм Александра Кайдановского — «Простая смерть»](https://ru.kinorium.com/214738/), где можно услышать запись голоса Льва Николаевича: «Нельзя так жить!».

///

## Моменты счастья в течение всей жизни {#moments_of_happiness}

Но ведь мы хотим быть счастливыми, начиная с сегодняшнего дня.
...
Этот период запомнился и стал одним из самых сильных жизненных кризисов: ты уже достиг поставленных глобальных целей, но потерял ощущение динамики роста.
...
Тогда я договорился с собой впредь не стесняться и следовать порыву мгновенно.
...
[Александр Иванович Юрьев](https://www.livelib.ru/quote/47010373-strategicheskaya-psihologiya-globalizatsii-psihologiya-chelovecheskogo-kapitala){ .author }
...
[Джордж Оруэлл](https://www.livelib.ru/quote/42434395-1984-dzhordzh-oruell){ .author }

///

То есть Счастье не является самоцелью, но мы испытываем его в пути — в движении к светлым целям!
...
## Измерение счастья {#happiness_model}
...
![Моменты счастья в формулах](img/slide7.png){ width="100%", loading=lazy }
/// caption
...
![Ничего не предвещало](img/leaf.jpg){ width="100%", loading=lazy }
/// caption
...
Понятно, что следовать рутинным процедурам подсчётов не многие готовы: постоянный контроль требует [наличия жизненных сил](p1-040-unhappiness.md#battery_aziz).
...
То же самое будет с измерением настроения и мы можем наблюдать первые попытки в этом направлении.

Но если пришло осознание, что каждый шаг и конфетка микроскопически влияют на конечный результат, то пол дела сделано!

Осознание позитивного уровня эмоционального тона в моменте формирует уверенность.

А визуализация кривой на графике интегральной модели счастья способствует формированию причинно-следственных связей.

Происходит геймификация нашей жизни: искусственное стимулирование действий человека.

Неплохо если эта геймификация направлена на повышение интегрального уровня счастья на протяжении жизни.
Но обычно она работает на замаскированную задачу перераспределения денежного капитала и создание зависимости от новой оплачиваемой игры или услуги.
