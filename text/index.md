...
Это для лучшего понимания, с кем вы тут столкнулись.
...
- Человек, который не позволяет себе игнорировать несоответствия реальности с представлением о мире.
...
И это уже не про «Душнилу» или «Токсика», а скорее про Аналитика.
...
[Владимир Плунгян](https://www.livelib.ru/quote/1055309-pochemu-yazyki-takie-raznye-vladimir-plungyan){ .author }
...
[Василий Аксёнов](https://www.livelib.ru/quote/78523-moskovskaya-saga-v-3-knigah-kniga-1-pokolenie-zimy-vasilij-aksenov){ .author }
...
А навыки вырабатываются в течение месяцев постоянной практики.
