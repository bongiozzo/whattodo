...
А кубик в результате пылится без дела.
...
Ребята из [Whoop](https://www.whoop.com/) сфокусировались и сделали ставку на эту метрику.
Мне она максимально интересна!
  
Система отслеживает биофизические параметры пульса, дыхания, температуры кожи, понимает характер активности — шаг, бег, спортивные занятия или отдых.

Приложение загружает и принимает во внимание медицинские лабораторные анализы, учитывает генетические особенности.

Организм рассматривается как [сбалансированная система](p2-110-system.md#paradox_for_peace) со способностью к Напряжению (Strain) и Восстановлению (Recovery).
Сон при этом выступает промежуточным звеном, связывающим эти две возможности.

Модули Искусственного Интеллекта платформы Whoop калибруют показания датчиков с 2,5 миллионами других пользователей, зная их возраст и особенности.

В результате ИИ-агент знает показатели организма в режиме реального времени и при этом имеет постоянный доступ к базе знаний медицинских университетов для выявления важных закономерностей.

И в результате выдаёт ваш биологический Whoop возраст и скорость разрушения/старения организма по отношению к нормальному течению времени.
Возраст может быть меньше реального на 5 лет, но скорость процессов разрушения в 2 раза выше — «ты всё спалил за час».

Общение с ИИ-агентом в приложении Whoop напоминает разговор с врачом или другом.
Он при этом усердно и честно направляет к специалистам, подчёркивая, что он лишь ИИ. 

Но ни один врач не в состоянии постоянно следить за параметрами организма и иметь детальные представления о всех возможных областях знаний о нашем теле.

Whoop показывает, какие факты используются в расчёте метрики старения и выдает довольно жёсткие рекомендации по изменению привычек — что делать, чтобы снизить эту скорость в первопричинах.
Когда ложиться спать, во сколько вставать, сколько пить воды, какие анализы сдать, чтобы исключить риски и так далее.
