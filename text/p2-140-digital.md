...
А в 2006 году российские политологи [задумались об объективных метриках](https://www.livelib.ru/quote/47030374-strategicheskaya-psihologiya-globalizatsii-psihologiya-chelovecheskogo-kapitala):
...
Они должны быть столь же научны и объективны, как данные о росте, массе тела, объёме легких граждан России.
...
[Александр Иванович Юрьев](https://www.livelib.ru/quote/47030374-strategicheskaya-psihologiya-globalizatsii-psihologiya-chelovecheskogo-kapitala){ .author }
...
### Ленин — цифровизатор? {#digital_lenin}
...
На мой взгляд, [начиная со школы и на наглядных, интересных и практических примерах](p2-120-school.md#happiness_in_school).
...
У этого подхода есть название — Quantified Self, вокруг которого даже [сформировалось общественное движение](https://ru.wikipedia.org/wiki/Quantified_self).
...
Непроизвольно встаю с седла, приналегаю на педали, адреналин поступает в кровь, и вот я уже лечу в мощнейшем ощущении Счастья!
...
И вот это среднее значение было совершенно нормальным.
...
Как во взвинченном моём состоянии не будет работать совет «Узбагойся!», так и во время бессонницы я не пытаюсь заснуть считая овец или занимаясь другим бессмысленным делом.
В этих попытках ещё больше раздражаешься от бездарной потери каждой минуты.

В своё время очень отозвалась история Тинькова, который не мог заснуть в [следовании собственному Призванию](p1-020-call.md#calling):
...
— Никак не дострою пивзавод.
Боюсь, что не смогу рассчитаться с банком.

— Когда построите, тогда и спать начнёте.

[Олег Тиньков](https://www.livelib.ru/quote/2030034-ya-takoj-kak-vse-oleg-tinkov){ .author }

///

Поэтому тоже учился обманывать своё сознание и поменял отношение к бессоннице.
...
Спустя пару лет подход стал ещё более умиротворяющим.

Когда просыпаешься среди ночи, мысли прошедшего дня зачастую выглядят иначе — без лишнего шума, в ясном виде и с другой стороны.
Важно зафиксировать этот взгляд, но чтобы не включать свет или экран устройства, я запрограммировал запись голосовой заметки на горячую кнопку телефона, которая потом автоматически преобразует звук в текстовое напоминание грядущего дня.

Уже в процессе переноса мыслей из головы в хранилище начинается приятная зевота — стресс снижается.

И остаётся лишь поблагодарить Бога в молитве
:-)
...
Хотя скажу, что если есть возможность спать на природе, поближе к земле, на свежем воздухе, то размениваться на кубик я точно не стану.

И в результате кубик пылится без дела в городе, а я стараюсь быть на земле или на воде.

///

Полезным результатом от этого опыта мне видится куда более осознанное отношение к сновидениям.
Особенно интересные даже записывал во время пробуждения как [моменты Счастья](p1-010-happiness.md#moments_of_happiness_book)…
:-)

/// situation

Спустя ещё полтора года [после появления Huawei часов](#health_pressure) медицинские показатели — давление, глюкоза, АЛАТ, АСАТ и тому подобные окончательно перестали быть интересными.

Нужна была измеримая, понятная, комплексная и важная метрика организма.

Пожалуй, трудно будет придумать что-либо важнее скорости приближения [Cмерти](p2-999-death.md)!
:-)

Ребята из [Whoop](https://www.whoop.com/) сфокусировались и сделали ставку на проработку этой метрики.
Мне она максимально интересна!
  
- Датчики отслеживают биофизические параметры пульса, дыхания, температуры кожи, понимают характер активности — шаг, бег, спортивные занятия или отдых;
- Приложение загружает и принимает во внимание медицинские лабораторные анализы, учитывает генетические особенности;
- Организм рассматривается как [сбалансированная система](p2-110-system.md#paradox_for_peace) с метриками способности Напряжения (Strain) и последующего Восстановления (Recovery);
- Сон при этом выступает промежуточным звеном, связывающим эти две способности;
- Эти соотношения наглядно и красиво показаны в инфографике;
- Платформа калибрует показания датчиков с данными 2,5 миллионов других пользователей, зная их возраст и особенности;
- Модели Искусственного интеллекта для выявления важных закономерностей вашего организма используют знания передовых медицинских институтов;
- ИИ-агент в роли собеседника-экспарта обращает внимание на отклонения и даёт практические рекомендации, напоминая о необходимости обращения к врачам в случае серьезных проблем.

В результате вы знаете свой биологический Whoop возраст и скорость разрушения/старения организма по отношению к нормальному течению времени.
Возраст может быть меньше реального на 5 лет, но скорость процессов разрушения в 2 раза выше — работает сценарий «ты всё спалил за час».

Whoop показывает, какие факты используются в расчёте метрики старения и выдает довольно жёсткие рекомендации по изменению привычек — что делать, чтобы снизить эту скорость в первопричинах — когда ложиться спать, во сколько вставать, сколько пить воды, какие анализы сдать, чтобы исключить потенциальные риски.
  
Эдакое добровольное делегирование своих поступков в сторону ИИ-агента получается.

Whoop постоянно объясняет, как устроен организм, не пытается «впарить» лекарство, которое не исправляет первопричину, а сокращает последствия и создаёт новые проблемы — это то, что мне было нужно!

///

[Знать свой организм](p2-110-system.md#noble_curiosity) и исключать медикаменты, если их можно избежать — правильная история.
...
[Лира Муховицкая](https://www.livelib.ru/quote/48372460-morozovy-dinastiya-metsenatov-lira-muhovitskaya){ .author }
...
Тут, как мне кажется, наилучшим образом работает [принцип следования Призванию](p1-020-call.md#calling) — когда не разделяешь работу от остальной жизни.
...
Мой дед Иван Кириллов в 1918 году юнцом ушёл в Красную Армию из многодетной семьи иконописца села ~~Кинель-Черкассы~~ Виловатое.

*Спустня несколько месяцев после написания этих строк специалисты Генотек нашли документы указывающиее на село Виловатое.*
...
В семейных разговорах за столом мама пересказывала воспоминания своей мамы о том, как Ленин, в его [бытность помощника адвоката в Самаре](#digital_lenin), заказал пошивку костюма.
...
![Приятно себя осознавать индейцем!](img/dna_myheritage.png){ width="100%", loading=lazy }
/// caption
...
Одной из самых сильных книг, оказавших влияние на привычки в работе, была [книга Элияху Голдратта «Цель»](https://www.livelib.ru/review/3908812-tsel-protsess-nepreryvnogo-uluchsheniya).
...
А когда ситуация сдвигается с мёртвой точки и нормализуется — надо искать другое узкое место, другое «бутылочное горлышко».
...
![Целеполагание изначально не свойственно человеку](img/goals.png){ width="100%", loading=lazy }
/// caption
Целеполагание изначально не свойственно человеку
///

Подход отлично работает в конкурентной среде, но было удивительно узнать, что целеполагание, как понятие, практически отсутствовало в литературе и, соответственно, в сознании до 1950 года и начало активно применяться лишь в 90-е:
...
[Адам Алтер](https://www.livelib.ru/quote/46741534-ne-otorvatsya-pochemu-nash-mozg-lyubit-vsjo-novoe-i-tak-li-eto-horosho-v-epohu-interneta-adam-alter){ .author }
...
Вероятно, лучшая производственная драма-триллер про критическое мышление и поиск узких мест в кинематографе — [фильм «Премия»](https://ru.kinorium.com/66917/).
