...
Учитывая, что он нацелен исправлять первопричину, постоянно объясняет, как устроен организм, и не пытается «впарить» лекарство, которое купирует следствие и создаёт новые проблемы — меня это более чем устраивает!

Знать свой организм и исключать медикаменты, если их можно избежать — правильная история.
