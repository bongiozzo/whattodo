...
Спустя ещё полтора года [после появления Huawei часов](#health_pressure) специфичные показатели — давление, глюкоза, АЛАТ, АСАТ и тому подобные окончательно перестали быть интересными.
...
Ну во всяком случае, мне она максимально интересна.
...
Приложение умеет загружать и принимать во внимание медицинские лабораторные анализы, учитывает генетические особенности.
...
Сон при этом выступает промежуточным звеном, связывающим эти две полярные метрики.

Система калибрует показания датчиков с помощью ИИ с 2,5 миллионами других пользователей, зная их возраст и особенности.

ИИ-агент лучше тебя знает показатели организма в режиме реального времени и при этом имеет постоянный доступ к базе знаний медицинских университетов.
...
И он усердно и честно направляет к специалистам, подчёркивая, что он лишь ИИ. 
Но ни один врач не в состоянии постоянно следить за параметрами организма и иметь детальные представления о всех возможных областях знаний нашего тела.
