...
Для врачей «от Бога» участие в этой борьбе является их Потребностью и [Призванием](p1-020-call.md#follow_your_calling).
...
ИИ стоит использовать прежде всего для поиска [взаимопонимания между людьми](p1-030-time.md#shared_vision), а [высвобожденное от рутины](p2-160-routine.md#routine_in_enterprises) время тратить на [реализацию Призвания](p1-020-call.md#follow_your_calling).
...
С помощью этого навыка агенты смогут находить новые трендовые [цели](#entity_goal), близкие [Призванию](p1-020-call.md#follow_your_calling) участника, и подбирать условия [контракта](#entity_contract), которые соответствуют его возможностям и принесут радость.
