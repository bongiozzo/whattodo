...
Однако, в результате уверенной риторики у многих в головах возникает упрощённое, без глубокого контекста понимание предшествующих кризису проблем — ответственность за текущую ситуацию обычно полностью возлагается на противоположную сторону конфликта.
...
Пишу и понимаю, что эти прекраснодушные метания не имеют быстрых и простых решений в [условиях огромной страны](p1-050-country.md) и разнородного населения.
...
Постоянное нахождение в привычном [Потоке](p1-020-call.md#flow) изучения новых технологий, рационализации и цифровизации жизни помимо Радости вызывает ещё и серьёзное утомление.
...
В результате был найден баланс — отдать эту землю в аренду тем, кто связывает своё [призвание](p1-020-call.md#calling) с её возделыванием.
...
Знание о системе богословия [преподобного Максима Исповедника](https://ru.wikipedia.org/wiki/Максим_Исповедник), в котором предназначение Человека определяется в исследовании материального мира и объединение его с внутренним Богом.
...
В результате для меня Вера — [это Путь](p1-010-happiness.md#happiness_pie).

/// quote

Я есть Путь...

[Иисус Христос](https://azbyka.ru/biblia/?Jn.14&r){ .author }
...
И, как будто бы, вдалеке там маячит [Счастье](p1-010-happiness.md#happiness_in_action).
...
Поиск баланса между двумя разными людьми в [стране, которая перекраивала системы координат](p1-050-country.md#russia_in_new_history), можно увидеть в замечательной [философской драме «Осенние сны»](https://ru.kinorium.com/238965/), например.
...
А религиозные каноны формировались под значительным влиянием политической ситуации в обществе на тот момент.

Поэтому на уровне абстракции верующих в Высшую Силу, а значит и в Вечную Жизнь, я могу задержаться и зафиксировать единую систему координат, как точку баланса.
...
Автор книг о Нарнии Клайв Стейплз Льюис нашёл гениальный художественный приём для рассуждения об этих недостатках — [«Письма Баламута»](https://www.livelib.ru/review/5738980-pisma-balamuta-balamut-predlagaet-tost-sbornik-klajv-stejplz-lyuis).

А на войне идёт борьба и работает совсем другая система ценностей.
И во внешней политике, пожалуй, доминирует первичный принцип — «все против всех».

/// quote

Эти национальные государства, обладающие внутренней монополией на законное насилие, обеспечивают гражданский мир внутри своих границ.
Можно их обозначить как веберианские государства.
...
![Любовь — корень квадратный из Истины](img/saharov.png){ width="75%", loading=lazy }
/// caption
...
- навык отдавать (время, деньги, себя) и не ждать ничего взамен
...
Поэтому Христос, в моём представлении, абсолютная форма Любви.

Любовь — навык, без которого, очень легко [стать несчастливым](p1-040-unhappiness.md#egocentrism).

Другой великий мыслитель предложил такую формулу, которая приводит к схожим выводам:
...
Это процент реализации [данных тебе Талантов в следовании Призванию](p1-020-call.md#calling).

Знаменатель больше единицы может быть…
:-)

Но стоит учиться уменьшать этот эгоцентричный знаменатель — передавать собственные наработки другим и уметь растворяться в окружающем мире, [становиться его частью](p1-010-happiness.md#what_is_happiness) и прийти в конце жизни к нулю.
...
Время, потраченное на развитие навыков «Отдавать» и [Помогать другим в реализации их Призвания](p1-020-call.md#calling), — важнейшая инвестиция в Счастье.
...
[Стивен Кови со своими навыками](https://www.livelib.ru/review/3792199-sem-navykov-vysokoeffektivnyh-lyudej) или другой американский писатель-коуч Дэн Миллман, создавший [учение о пути Мирного Воина](https://ru.kinorium.com/333197/), в котором сформулировано три принципа, эксплуатируют схожие ценности и модели.
...
## Практика медитации {#practicing_meditation}
...
Но вернувшись в Россию, где нет чарующих звуков гонга, нет пагод и озера, а вместо этого — перелёты постоянные, Самара с пляжами и песком в трусах, Питер, Москва, встречи, переговоры, десятки инициатив под контролем, дети, друзья и близкие — уже и обстановки подходящей для медитаций не стало.

/// note

Спустя пару лет, наблюдая за непрерывными рациональными поисками практик душевного равновесия у друзей, начинаешь понимать, что сам факт рождения твоего «Я» в определённое время и в конкретном месте не может быть рационально объяснён.

В разных частях света за всю историю человечества и под разные исторические ситуации появилось бесконечное множество практик.
Жизни не хватит их все на себя примерить.

И значит можно спокойно отнестись к выбору в подходе «Дано».

И взять за основу практику, которая глубоко проросла в родную культуру и выживала в разных кризисах последнюю тысячу лет. 
...
И хотя слово «бесы» у меня одно время вызывало смешливую ассоциацию, то вот образ лукавого, в исполнении потрясающего Аль Пачино в [«Адвокате Дьявола»](https://ru.kinorium.com/107759/) вполне себе заслуживает очень серьёзной и искренней просьбы о помощи…
...
Очень удивился и порадовался, когда спустя несколько лет после такой практики практически слово в слово обнаружил похожее отношение к молитве, как к необходимой временной инвестиции, с явным включением слова «программа»:
...
[Антоний Сурожский](https://www.livelib.ru/quote/48970867-ne-mogu-gospodi-zhit-bez-tebya-kniga-o-molitve-mitropolit-antonij-surozhskij){ .author }
...
Как только глубина и осознанность ушли из молитвы и она помертвела.
Когда уже не ем, а «потребляю калории» без молитвы вовсе (хотя такое уже реже случается).
Значит, дело плохо, и [поток](p1-020-call.md#flow) превратился в пучину «неотложных» срочных, и не факт, что важных дел.
Я перестал отслеживать ориентиры, у меня в голове опять превалирует один полюс и меня может выбросить на мель или разбить о скалы.
...
[Сборник рассуждений Митрополита Антония Сурожского](https://www.livelib.ru/review/5900392-ne-mogu-gospodi-zhit-bez-tebya-kniga-o-molitve-mitropolit-antonij-surozhskij) на тему молитвенного состояния оказался невероятно глубоким и, вместе с тем, радостным чтением.
Примеры с любовью к мытью посуды или наблюдению за птицами вызывали улыбку — [эффект узнавания](index.md#emotional_parts).   

История разговора с мышкой и недостатком веры в молитву повеселила, но подсветила области дальнейшей работы.

Отдельно отметил случай с группой хиппи, которые хотели научиться молиться.
Они получили опыт совместной продолжительной молитвы, но в процессе сформулировали понимание Православия в целом — конечно же, мыслительная деятельность [эгоцентричный процесс](p1-040-unhappiness.md#egocentrism), но молитва также [может быть общей](p1-040-unhappiness.md#egocentrism_is_not_happiness) и это [поток нахождения в радости](p1-010-happiness.md#happiness_in_action).

Рекомендую эту книгу как практический материал от человека, который глубоко любил Бога и сам процесс разговора с Ним.
...
Хотя на первое место, пожалуй, стоило бы поставить истинное [Призвание](p1-020-call.md#calling), ведь предпринимателем я когда-то стал по необходимости — если бы не надо было искать деньги в конце девяностых, чтобы продолжать заниматься любимым занятием — созданием информационных систем — так и остался бы программистом/архитектором.
...
А принципы, озвученные в [Нагорной проповеди](https://ru.wikipedia.org/wiki/Нагорная_проповедь), стали намного ближе и роднее.
...
В свежепросмотренном кино с этой идеей проассоциировался Иван из [фильма «Фрау»](https://ru.kinorium.com/2905794/).
