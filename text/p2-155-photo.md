...
description: Фотографировать и делиться снимками — прекрасный способ приумножения радости
---
...
[Георгий Рерберг](https://ru.wikipedia.org/wiki/Рерберг,_Георгий_Иванович){ .author }
...
[Михаил Михайлович Зощенко](https://www.livelib.ru/quote/48042808-pered-voshodom-solntsa-mihail-zoschenko){ .author }
...
Из шедевров кинематографа на ум приходит [фильм «Зеркало» Тарковского](https://ru.kinorium.com/67295/).
...
[Наринэ Абгарян](https://www.livelib.ru/quote/799961-lyudi-kotorye-vsegda-so-mnoj-narine-abgaryan){ .author }
...
[Лев Наумов](https://www.livelib.ru/quote/48072508-italyanskie-marshruty-andreya-tarkovskogo-lev-naumov){ .author }
...
![Два пепелаца в сжатой перспективе](img/photo_tele.jpg){ width="100%", loading=lazy }
/// caption
...
[Галерея путешествий](https://photo.bongiozzo.ru/disk/travel)

Когда обзавёлся качественной оптикой начинают возникать соблазны забраться ещё дальше.
Приходится вставать пораньше, чтобы в восход запечатлеть красоту неземную.
...
[Галерея пейзажей](https://photo.bongiozzo.ru/disk/landscapes)
...
[Вера Алентова](https://www.livelib.ru/quote/48190393-vsjo-ne-sluchajno-vera-alentova){ .author }
...
[Походная галерея](https://photo.bongiozzo.ru/disk/hike)
...
[Концертная галерея](https://photo.bongiozzo.ru/disk/music)
...
![Зрители](img/photo_theatre.jpg){ width="100%", loading=lazy }
/// caption
Зрители
///
...
[Театральная галерея](https://photo.bongiozzo.ru/disk/theater)
...
Он выжал из бизнеса, который [совпадает с его Призванием](p1-020-call.md#calling), максимум того, что можно достичь в нашем городе.
...
2. Композиция кадра — изображение гармонично, есть визуальный ритм, используются правила третей или золотого сечения, соблюдены отступы и так далее;
3. Многоплановость — есть пространство для изучения кадра взглядом, присутствуют объекты на переднем и заднем плане, чувствуется глубина, перспектива.
...
Что такое плавдом я поясню ниже, а пока лишь отмечу, что в одном удивительном месте оказалось два фотографа.
...
### Александр Бердников {#vodoplav}

/// note

Спустя год после публикации главы, находясь во втором путешествии во время приличной качки, стало понятно, что необходимо добавить главу о плавдоме и его создателе.
...
Так же как и в музыке, [Искусственный Интеллект](p1-030-time.md#happy_tomorrow), на мой взгляд, [является угрозой для фонограмщиков и ремесленников](p2-150-absurd.md#genai_in_music) — то есть, для людей, которые занимаются искусством уже не по [Любви](p2-110-system.md#love_as_labor) и [Призванию](p1-020-call.md#calling), а больше ради денег.
...
[Андрей Тарковский](https://www.livelib.ru/quote/48219463-italyanskie-marshruty-andreya-tarkovskogo-lev-naumov){ .author }
