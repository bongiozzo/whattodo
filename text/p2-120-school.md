...
Уклад современного общества в мирное время позволяет прожить без них, хотя 1000 лет назад именно навыки Воли, а не [Разума](#psychology_of_mind), были критичными для лидерства.
...
Но если взглянуть на Веру в контексте сотен тысячелетий эволюции, то она скорее видится как необходимый предохранитель для наших мыслительных возможностей от перегрева в понимании и планировании бесконечно сложного мира.
...
Вероятно только максимально развитые навыки психологии Веры позволяют конвертировать неприемлемое для многих понятие Смирения и укрощения собственной Гордыни в навык полного Доверия и Принятия окружающего мира, необходимого для высшего уровня [Просветления (8)](#perl) по модели ПЭРЛ.
...
Которая появилась на заре подъёма психологии Разума — молиться о выздоровлении уже стало немодно, но ещё не сформировалась доказательная научная база и сверхприбыльная фармакологическая отрасль.
...
И также как я [заменил в голове понятие слова Любовь с чувства сначала на глагол, а потом на труд](p2-110-system.md#love_as_labor), также, вероятно, Веру стоит воспринимать как действие с пониманием затраченного времени — [молюсь](p2-110-system.md#practicing_meditation), [практикую](p2-100-authors.md#savvasahib), [исповедую](p2-100-authors.md#mosroute) или евангелизирую ([как делал это ещё в Microsoft](p1-010-happiness.md#moments_of_happiness)).

И, вероятно, потребуется мобилизовать все навыки [Разума](#psychology_of_mind), [Воли](#psychology_of_will) и [Чувств](#psychology_of_unconscious) и направить их на практику [молитвы](p2-110-system.md#practicing_meditation), чтобы этим сплавом заполнить пустующую внутри форму и достичь [благоговения — ощущение присутствия Бога](p1-020-call.md#sense_of_awe).
