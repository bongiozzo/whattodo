...
Например, она позволила мне самому принять решение о смене школы после 8-го класса.

И стоит заметить, что новая школа в 9 и 10-м классе была тоже невероятная.
Эксперементальная.
И основная ассоциация с ней – это свобода, которая особенно ощущалась после 8 лет учёбы.

Все эти годы я был элементом размеренного учебного процесса и ходил на уроки по 45 минут в типовое здание среднеобразовательной советской школы одного из микрорайонов промышленного города.
И вдруг нашими преподавателями стали учителя из ВУЗов, к которым мы ездили на занятия в разные корпуса по городу.
...
Преподаватели пошли на встречу и мне удалось получить к ним доступ сначала на выходных, потом в вечернее, а следом и в дневное время.
В конечном итоге мне позволили оставаться в компьютерных классах на ночь.
Но с условием:

– Увидим, что играешь в игры, доступ будет закрыт!
...
И мама, и директор школы Марина Венедиктовна Наянова, попустительствовали моим залётам и, видимо, они чувствовали, что я нащупал своё [Призвание](p1-020-call.md#follow_your_calling).
