...
Разработчики проанализировали бурный рост краба-пионера и внесли изменения в процессы работы с памятью.

Память у Hermes в базовой настройке очень ограничена и быстро заполняется.
Сравнимо с человеком.
Но его механика предполагает высвобождение memory через фоновую конвертацию в [skills](p2-160-routine.md#agent_skills).

Накопленная информация (опыт) качественно перетекает в привычки.
Этакий получается субъекь, который постоянно анализирует полученный опыт и вырабатывает полезные привычки, чтобы далее им следовать на автомате.

Очень забавное [пересечение психологии и подходов в программировании](p2-110-system.md#nlp_and_pray).

И это очень улекательно.
Я [нахожусь в Потоке](p1-020-call.md#flow).

Но зачастую этот поток заносит тебя в тупик.

Нарушается баланс, теряешь контроль и в результате тратишь слишком много сил на элементарную (как выясняется по факту) задачу.

Осознал, что возвращать себя в сбалансированное состояние может помочь молитва.
Попробую программировать вместе с молитвой :-)