...
## 2. Цели государства и Потребности граждан {#goals_needs style="page-break-before: always;"}
...
## 3. Каналы коммуникаций {#communication_channels style="page-break-before: always;"}
...
## 4. Гражданин не равно Клиент {#citizen_client style="page-break-before: always;"}
...
## 5. Счастье как смысл жизни {#happiness_as_mission style="page-break-before: always;"}
...
## 6. Научное сообщество о Счастье {#science_about_happiness style="page-break-before: always;"}
...
## 7. Состояния Счастья {#states_of_happiness style="page-break-before: always;"}
...
## 8. Пирог Счастья {#pie_of_happiness style="page-break-before: always;"}
...
## 9. Путь Этапов Развития Личности {#path_of_happiness style="page-break-before: always;"}
...
1. [Иррациональный навык найти свой Интерес](p2-120-school.md#psychology_of_unconscious) и [следовать Призванию](p1-020-call.md#calling), возможно вопреки голосу Разума — многие себя так и не реализовали на этом этапе;
...
## 10. Петербург в поисках Счастья {#petersburg_and_happiness style="page-break-before: always;"}
...
## 11. Культурная столица {#culture_capital style="page-break-before: always;"}
...
## 12. Цифровой Петербург {#digital_petersburg style="page-break-before: always;"}
...
## 13. Я Здесь Живу {#i_live_here_app style="page-break-before: always;"}
...
## 14. Подход Цифрового Петербурга {#roots_approach style="page-break-before: always;"}
...
## 15. Новые метрики {#new_metrics style="page-break-before: always;"}
...
## 16. Определение Социального капитала {#social_capital_definition style="page-break-before: always;"}
...
## 17. Новое осмысление Умного Города {#smart_city_slide style="page-break-before: always;"}
...
## 18. Житель — инвестор, а не потребитель {#citizen_investor style="page-break-before: always;"}
...
## 19. Вовлечение в инвестиции {#investment_involvement style="page-break-before: always;"}
...
## 20. Общие цели {#shared_goals_slide style="page-break-before: always;"}
...
## 21. Что мне делать? :-) {#this_text style="page-break-before: always;"}
...
## 22. Подтверждение гипотезы {#proof style="page-break-before: always;"}
...
## 23. Желаемый результат {#result style="page-break-before: always;"}
...
## 24. Необходимые условия {#requirements style="page-break-before: always;"}
...
Конечно же, содержанием школьной программы занимаются специалисты в образовании, и пока предмета о Счастье в школе нет, ответственность за счастливое завтра детей лежит преимущественно на плечах родителей.
...
## 25. Проектная группа {#project_team style="page-break-before: always;"}
...
## 26. Задачи проектной группы {#project_tasks style="page-break-before: always;"}
