...
[Лев Толстой](https://tolstoy.ru/creativity/journalismguide/139.php){ .author }
...
Такой же шедевр из области коммуникаций — [Telegram клиенты для компьютера](https://github.com/telegramdesktop/tdesktop), [iOS](https://github.com/telegrammessenger/telegram-ios) или [Android](https://github.com/DrKLO/Telegram).

Когда далёкие от информационных технологий люди спрашивают, «Почему Telegram лучший мессенджер?» хочется ответить — «Потому что приложение открыто в коде и нацелено на постоянное развитие, поэтому оно будет безопаснее и богаче закрытых аналогов».

Но не все понимают связь.

### Apple — Домострой {#apple_domostroy}

А если брать примеры отношения к своему продукту, как к шедевру, но из материального технологического мира, то неминуемо вспоминаешь продукцию компании Apple:

/// quote

Каждый, кто держал в руках с любовной тщательностью произведенный MacBook или любой другой девайс от Apple, раз и навсегда почувствовал, насколько выдающийся результат принесла одержимость Стива Джобса внешним лоском и максимальным удобством в использовании.
Но главный урок, данный нам всем Стивом Джобсом, не имеет ничего общего с эстетикой. Величайшим дизайнерским успехом Джобса стал его бизнес.
Корпорация Apple создавала и воплощала в жизнь детальные многолетние планы разработки новых продуктов и их эффективных продаж.
Забудьте о «минимально жизнеспособных продуктах»!

Уже в 1976 году, создавая Apple, Джобс отлично понимал: чтобы изменить мир, нужно тщательно планировать каждый шаг — а не прислушиваться к мнению фокус-групп и копировать чужие успехи.

[Питер Тиль](https://www.livelib.ru/quote/47530826-ot-nulya-k-edinitse-kak-sozdat-startap-kotoryj-izmenit-buduschee-piter-til-blejk-masters-peter-thiel-koos-blake-mastersiga){ .author }

///

И здесь нет никакого противоречия с концепцией Open Source.

На моих MacBook и Mac Studio более 90% загрузки процессора приходится на открытые приложения, такие как Visual Studio Code и Telegram.
А работают они на MacOS из семейства Unix, к которому также относится популярная open source операционка GNU Linux.

С одной стороны Apple частично ограничивает свободу выбора пользователя, но с другой — предоставляет совершенную совместимость между устройствами.
Чтобы всё работало!

[Баланс и парадокс](p2-110-system.md#paradox_for_peace).

Напомнило концепцию [Домостроя](p2-140-digital.md#why_digital_russia), но в компьютерном мире.
...
![Фрагмент фильма «Революционная ОС»](img/bill_letter.jpg){ width="75%", loading=lazy }
/// caption
Фрагмент фильма «Революционная ОС»
///

Узнать [эту историю](https://youtu.be/n1F_MfLRlX0?si=aRpSa3kKaqhLEBcm&t=829) в деталях можно от непосредственных участников тех событий в документальном фильме [«Революционная ОС»](https://ru.kinorium.com/244450/).
...
Если все проголосовали, люди начинают её писать.
...
[Microsoft Consulting Services](p1-020-call.md#dream_job_checklist) спокойно берёт со своих клиентов деньги за техническую поддержку проектов с открытым кодом.

/// situation

**Сергей Поляков:**

— В [Microsoft Consulting Services](p1-020-call.md#dream_job_checklist) нас учили продажам лучшие эксперты в мире.
Знания закладывались всеми способами воздействия!

Через процессы и структуры, как, например, критерии этапов любой сделки — Pain, Power, Vision, Value, Control.
Обучение происходило в работе с эмоциями и невербальными знаками с [учётом психотипов](p1-020-call.md#mbti_personalities).
И даже закреплялось через телесный опыт на примере координации движений при жонглировании — чтобы не повторить ошибку нужно чётко представлять, что именно скорректируешь в следующий раз.

Многодневные тренинги готовили к изощрённым ситуациям.

Один тренер из Шотландии особенно запомнился тем, что в последний 4-й день наиболее глубокого курса он записал основной принцип продавца:

Open Heart — откройте Ваше сердце и помогите клиенту решить его задачу.

Я очень удивился:

— Это ведь так просто, зачем были нужны все эти ухищрения?
