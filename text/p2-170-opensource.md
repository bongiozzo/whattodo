...
А управляются они операционной системой на базе Unix, неразрывно связанной с концепцией открытого кода.

И Apple частивно ограничивает свободу выбора, но добавляет порядка и предсказуемости в материально-железячном, совместимом друг с другом формфакторе.
Чтобы всё работало.
