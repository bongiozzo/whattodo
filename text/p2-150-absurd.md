...
После выхода одного из последних альбомов группы Hipocrisy я заглянул к ним на страницу.
...
И вот эти незаметные и рациональные нормы представляют куда большие угрозы для [евангельской системы координат](p2-110-system.md#rational_definition_of_christ), поскольку легко [берутся на вооружение детьми](p2-120-school.md#happiness_in_school).
