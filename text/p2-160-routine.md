...
При этом, чем дальше от [Призвания](p1-020-call.md#calling) эта профессия, за которую платят деньги — тем больше рутины в жизни.
...
И тут в дискуссию вклинивается руководитель департамента [Microsoft Consulting Services](p1-020-call.md#dream_job_checklist):
...
И в завершение, например, отправляет электронное письмо со стандартной резолюцией.
...
В [Microsoft Consulting Services](p1-020-call.md#dream_job_checklist) такая технология называлась Customer Care Framework и предназначалась для интеграции устаревших систем.
...
В начале это неприязнь и непонимание, но в завершение это расцветающие лица людей, которые светятся в петербургской хмури при демонстрации результатов.
...
Все эти действия по отдельности умеют делать программы-агенты.
...
## Навыки агентов-помощников {#agent_skills}

Развитие текстовых моделей в направлении Действий проявилось в появлении открытых форматов — Навыки или [Agent Skills](https://agentskills.io/home).

Навык представляет собой пакет, объединяющий гибкость текстовой LLM и точность программы-скрипта как неизменного принципа.

/// abstract | Пример

Простой и однозначный скрипт скачивает документ с конкретного URL.

LLM обрабатывает документ промптами этого Навыка и результирующий текст может быть довольно произвольный.

Следом другой скрипт приводит результат к чёткому формату и отсекает исключения.

///

Можно сформировать набор навыков для работы и использовать их в разных проектах и ситуациях.

При этом в критически важных процессах ответственость за результат останется за человеком, но рутинная подготовительная работа уже будет сделана роботами и агентами с необходимыми навыками.

Скорее всего на работе такие подходы станут широко применяться после распространения в повседневной жизни.

В 2023-м пробовал прожить без Google и Yandex поисковиков в течение недели и пользовался только ChatGPT.
У меня вполне получалось — всё-таки формат Telegram общения для меня основной.
...
И спустя год кролик Rabbit R1 (по той же ссылке) причудливым образом трансформировался в крабоподобного агента OpenClaw :-)

А видение ведь изначально было верным.
...
Если раньше [Следование Призванию](p1-020-call.md#calling) было иррациональным стремлением к саморазвитию в области своего Интереса и приносило Счастье.
Это был Пряник.
...
Думаю, что среди нас внушительное количество прекрасных Учителей с любовью к литературе, точным наукам, животному миру, природе, танцам и пению, которые выбрали рутинную работу ради большего заработка.
Настоящий Учитель, если будет рассматривать искусственный интеллект не как соперника, а как помощника, сможет передать свою [Любовь](p2-110-system.md#love_as_labor) как Искру каждому ученику на его языке.
[Ведь все мы разные](p1-030-time.md#shared_vision)!

Но передать эту Искру бережно, из рук в руки, может только Человек Человеку.
...
И если Дочь уже, надеюсь, нащупывает своё [Призвание](p1-020-call.md#calling), то Сыну ещё предстоит.

И, уже возможно ставить задачу для ИИ подбора профессии под круг своих интересов и увлечений.
Важно, чтобы они были в [безопасной системе координат](p2-110-system.md#family_priorities).
...
Может быть, «поможет» необходимость от растущего влияния техногенных и геополитических факторов — бурное развитие ИИ и усиление конфликтов?

… и нас ждёт новая эпоха [Возрождения Идеалов](p2-120-school.md#idealization) и [Веры](p2-120-school.md#psychology_of_belief)?
