...
В выборе инструментария я решил не изменять своему [Призванию программиста](p1-020-call.md#architect_personality).
...
[Инструментарий Git](https://github.com/git/git) разрабатывается в [концепции Open Source](p2-170-opensource.md), которая не предполагает оплаты лицензий за использование программным продуктом.
...
Да.
И можно развернуть собственную инфраструктуру git, чтобы ни от кого не зависеть, но я решил использовать доступный [GitHub](https://github.com) и вот почему.
...
<!-- TODO replace .Для тех, кому совсем нелюбопытно пробовать самому, приведу тут ответ.
[%collapsible]
====
[source,asciidoc]
----
...
<!-- TODO replace А для вас поделюсь [ссылкой на этот результат работы искусственного интеллекта,window=_blank](https://text.sharedgoals.ru/ru/_attachments/reveal.html). -->
...
Для того чтобы сделать свою версию Текста, достаточно нажать ссылку в верхнем правом углу сайта – [«Писать»](https://github.com/bongiozzo/whattodo/) или [«Редактировать текст»](https://github.com/bongiozzo/whattodo/edit/master/ru/modules/ROOT/pages/p2-200-text.adoc).
