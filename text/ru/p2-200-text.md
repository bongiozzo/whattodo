...
**tooling/text-forge/epub/book_meta.yml:**

- [x] Внести такие же корректировки для книжного формата Epub (если используете сборку через submodule `tooling/text-forge`);
