...
-- site_url: указать получившуюся при публикации ссылку GitHub или привязать к собственному домену в настройках проекта;
-- site_author, copyright, site_description: очевидные изменения;
-- repo_url: ссылка на github проект;
...
- epub/book_meta.yml:
-- Внести такие же корректировки для книжного формата Epub;
...
Разговаривали с другом про персональные системы ценностей, которые стоит выписать.
...
И Думающая модель, которая его прочитала, вполне может выдать краткий список.

По запросу Perprlexity Research выделил десяток пунктов, которые я сам распределил на 3 блока:
