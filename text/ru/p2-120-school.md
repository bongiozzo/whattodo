...
Пожалуй, в ещё более жесткой конкурентной системе координат пребывает внешняя политика.
...
Администрация США изначально поддерживала борца за Свободу, ведь это понятие обозначено в декларации независимости их государства от Британской империи, перед правом на стремление к Счастью.
...
Лучше осознаёшь влияние зависимостей от модификаторов состояния.
...
В моей жизни уже произошли тысячи моментов счастья, которые я начал систематизировать.
...
Наш организм, формировавшийся эволюцией сотни тысячи лет, значительно не изменился за последние сотню лет.
...
Уклад современного общества в мирное время позволяет прожить без них, хотя 1000 лет назад именно навыки Воли, а не Разума, были критичными для лидерства.
...
Именно поэтому Деньги лишь кажущийся атрибут Счастья.
...
Психология Бессознательного или психология Чувств даёт нам возможность компенсировать потраченные силы на Разум и Волю.
...
Испытываешь благоговение и состояние Счастья.

Искусство по своей сути также снимает ограничения.
Те, кто выбирают творческую деятельность в живописи, литературе, вокале, танцах или другом своём Призвании – максимально развивают эти навыки.
...
Хотя и тут человечество нашло суррогаты и быстрые способы достижения Счастья и перехода в бессознательное с помощью разнообразных веществ, вызывающих зависимости.
...
Ведь несмотря на, казалось бы, очевидный финал наших усилий и тщетность результата в понятиях материализма, именно Вера в завтрашний день и Счастье, которое мы испытываем в движении, не дают нам останавливаться.

По ресурсной модели внимания Канемана для пребывания в позитивном (счастливом) состоянии человек постоянно прикладывает умственные усилия.

Когда по естественным причинам падает ёмкость физических и психических сил или когда достигнуты максимально высокие результаты, мы начинаем чувствовать растущую важность подведения оценки уже во многом прожитой жизни.
Требуется устойчивая модель координат и принципов, на которую можно опереться в условии ограниченного ресурса психологии Разума и которая даёт ответ на важнейший вопрос о Смысле жизни.
...
Или, если сказать иначе, проявление Воли в объединении Разума и Веры.
...
При определённой гибкости мышления и широте взглядов Вера не исключает ни Разума, ни Чувств, но даёт направление дальнейшего движения и формирует опору.
...
Они были движимы не Любовью, а только Волей и Разумом.
...
Как не крути – не получается идею концлагеря впихнуть в евангельскую систему координат.
В нацистской пропаганде использовались искажённые смыслы Ницше, а общество с воодушевлением включалось в игру.

Кажется, что ницшеанскому сверхчеловеку-творцу, который рвёт неработающие догмы, развивает дух и строит свои системы ценностей, не остаётся ничего другого, как [начиная с 4-го уровня Необходимости](perl) отходить от уже не приносящего счастья материализма и брать за основу систему координат, сформулированную 2 000 лет назад.
...
За прошедшие 53 года после речи Франкла общество потребления, разрушающее идеалы и развивающее психологию Чувств уже в цифровом формате, поднимает планку уровня игры.

Важность Идеализации и навыков Веры возрастает соответственно.

Воля и Разум необходимы, чтобы двигаться к созидательным Идеалам.

Счастье ощущается в этом движении.

Развитые навыки Чувств дают возможность испытывать его в полной мере и в широком спектре наших эмоций. 
...
В семьях с устоявшейся системой ценностей, где заметное место занимают:

* Учёба и тренировка навыков Разума, чтобы уметь добывать необходимые ресурсы,
* Вера в духовные идеалы, которая служит стержнем, формирует систему координат и ориентиры для роста,
...
Троица – три точки для твёрдой опоры плюс четвёртая для отдыха — сбалансированное развитие всех сфер психологии: Разум, Вера, Воля и Бессознательное.

Эти компоненты похожи на чертёж генератора моментов счастья!
:-)
...
Христиане приближают его к себе через понятие Богочеловека в образе Христа.
...
Не в ветхозаветное время, а в новую историю последних 200 лет эти просветлённые люди жили в наших городах — в Сарове Серафим Саровский, в Санкт-Петербурге Иоанн Кронштадтский и [Серафим Вырицкий](https://ru.wikipedia.org/wiki/Серафим_Вырицкий).
...
!!! note "Дополнение"
    ...
    Мыслили они во [многом одинаково](https://www.livelib.ru/quote/48261079-svyatoj-protiv-lva-ioann-kronshtadtskij-i-lev-tolstoj-istoriya-odnoj-vrazhdy-pavel-basinskij), но шли к [Вере](psychology*of*will) с разных сторон.

    Оттого было особенно интересно разобраться, что [было их общей целью и в чём были корневые отличия их сознания](p1-030-time.md#shared*vision) при очевидно [разных психотипах](p1-020-call.md#mbti*personalities) и разных начальных условиях при рождении.

    Иоанн поднимался с социального низа, изначально [поверив в Таинство церковных обрядов](psychology*of*belief), он развивал свой [Разум](psychology*of*mind) и укреплял [Парадоксальный баланс](p2-110-system.md#paradox) внутри.
    ...
    Всеми силами через внутреннюю [дисциплину](psychology*of*will) и могучий [разум](psychology*of*mind) он [определял приоритеты и систему координат](p2-110-system.md#refining_priorities) для поиска ответа на [вопрос о смысле жизни](https://www.livelib.ru/quote/48253984-lev-tolstoj-svobodnyj-chelovek-pavel-basinskij).
    Шёл он к христианским [идеалам](idealization), не щадя себя и не принимая в расчёт состояние жены и позицию государства, которое базово существует в конкурентной, не [евангельской системе координат](p2-110-system.md#rational*definition*of_christ) и вынуждено балансировать, реагируя на внешние угрозы с учётом внутренней напряжённости и экономики.

    Путь к своей [Вере](psychology*of*belief) Лев Николаевич изложил [в одноимённом произведении «В чём моя вера?»](https://www.livelib.ru/review/5301010-v-chem-moya-vera-lev-tolstoj).

    За 30 лет до этого произведения он уже видел свою [цель больше жизни](p2-110-system.md#larger*than*life) в создании [практической христианской религии без Таинства](https://www.livelib.ru/quote/48239752-lev-tolstoj-svobodnyj-chelovek-pavel-basinskij), без которого невозможно само учение Христа и, как следствие, Православная Церковь.

    Мне [(INTJ)](p1-020-call.md#architect*personality) понятен образ мыслей Льва Толстого [(INFJ)](https://www.perplexity.ai/search/what-type-of-mbti-archetype-le-oXXBt.kmRnuyWzOHaIC.*A), который имел ещё более редкий психотип с развитой [психологией Чувств (Feeling)](psychology*of*unconscious).
    ...
    - Писательство он выбрал как основной вид деятельности, отказавшись от завидной карьеры военного и юриста и успешно используя Богом данный талант и [богатейшую палитру чувств](psychology*of*unconscious) в описании событий и вызовов, которым [он решительно следовал](index.md#right*now). Очевидно этот вид деятельности был его [Призванием](p1-020-call.md#follow*your_calling) (5-й уровень Интереса).
...
Эта поправка на сформированный нашей историей, культурой, природой и климатом менталитет очень важна!
...
Как минимум, это позволит объяснить и сократить риски возникновения физиологических зависимостей от употребления разнообразных веществ до завершения формирования организма в 30 лет.
...
*Автор текста: (Людмила Полякова)_
...
Крупными мазками нарисовать 4 типа мозговой деятельности, которые хорошо бы гармонизировать для полного Счастья.
