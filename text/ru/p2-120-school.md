...
Или, если сказать иначе, проявление [Воли](psychology_of_will) в объединении [Разума](psychology_of_mind) и Веры.
...
[Троица – три точки для твёрдой опоры](p2-110-system.md#human_as_god) плюс четвёртая для отдыха — [сбалансированное развитие всех сфер психологии: Разум, Вера, Воля и Бессознательное](types_of_psychology).
