...
Нетрудно проследить, как [маятник изменения сознания на более материалистичное восприятие, запущенный в России и ушедший на Запад, вернулся к нам в 80-е](xref:p1-040-unhappiness.adoc#intelligence_quotient).
