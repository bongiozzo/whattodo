...
После прочтения этой книги, где рассматриваются всевозможные пути создания сверхразума, могу с уверенностью сказать, что роль пока ещё слабого ИИ как Инструмента в постоянном [снижении поляризации](p2-110-system.md#polarization) в обществе выглядит наилучшим сценарием.
