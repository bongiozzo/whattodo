...
Мы знаем это из школьной программы, хотя и во взрослой жизни стоит освежить эти знания в лёгком формате первой части книги [«Sapiens. Краткая история человечества»](https://www.livelib.ru/book/1002920757-sapiens-kratkaya-istoriya-chelovechestva-yuval-noj-harari).
...
Также глубоко любимый мною [Оззи Осборн описал свою жизнь](https://www.livelib.ru/review/3752326-ya-ozzi-vsjo-chto-mne-udalos-vspomnit).
...
- Если в молодости (во время формирования организма) в стремлении к счастью и радости «хватило ума» воздействовать на «часовой механизм» эмоционального тона «кувалдой» стимуляторов;
- Если этому образу эйфории удалось закрепиться в нейронных цепочках;
- То, скорее всего, наш мозг будет стимулировать желание повторить этот опыт на протяжении всей жизни.
...
Лично для себя сделал вывод, что [следование Призванию](p1-020-call.md#calling) может сохранять здоровье лучше, чем борьба «на волевых».
...
На первый взгляд цели эти идеалистические и способствующие росту счастья.

Ведь интересно же опускаться на дно океана, летать на другие планеты или изучать историю!

И при осознанном потреблении ресурсов, когда излишки перераспределяются — на всех хватит!
...
Однако сознание у людей, объективно, не было готово к таким переменам и идеалам.
...
В момент написания этого абзаца совершенно не хотелось лезть в дебри [креационизма](https://ru.wikipedia.org/wiki/Креационизм) и вникать в противоречия религии, естественных наук и философии.
...
Как только технологический прогресс дойдёт до появления искусственного интеллекта, централизованного или децентрализованного, который превосходит наш по скорости и качеству результата, и который мы не сможем контролировать, наступает, так называемая точка технологической сингулярности.
...
ИИ быстрее и лучше нас выполняет преобразование вопросов в ответы в большинстве интеллектуальных задач, и их качество неуклонно растёт.
Всё, что можно так или иначе представить в виде Текста, подходит для применения.

Стоимость работы Искусственного Интеллекта значительно ниже стоимости работы Разумного Человека — значит сотрудников будет требоваться всё меньше.

Соотношение объёма работы, выполняемой ИИ, и работы, выполняемой человеком, в работе с текстами разных видов уже стремительно меняется.

Вычисления давным-давно распределены и инфраструктура защищена от таких ситуаций, как потеря электропитания.

Команды, отправленные в информационные системы через программные интерфейсы, запускают действия в нашем реальном мире.

Как это повлияет на процессы в обществе?
Учитывая, что мы катимся по рельсам мироустройства с конкурентным перераспределением ресурсов…

Мы можем лишь верить, что всё к лучшему!
:-)
...
~~Если~~ Когда Искусственный Интеллект значительно превзойдёт человеческий в самом широком спектре решаемых задач, а Эгоцентричный Разум направит его на достижение тотального конкурентного преимущества — на кого можно будет надеяться оппонентам ? :-)
