...
Видел тому множество примеров в жизни и всерьёз считаю, что физическое здоровье зависит от гармонии в сознании.

Чтобы ощущать этот баланс, стараюсь критически относиться к происходящему в обществе и занимать противоположную точку зрения в беседах по важным вопросам.
...
## Разность восприятия в разных культурах  {#different_culture}
...
1. Декларация независимости: В ней упоминается "право на жизнь, свободу и стремление к счастью".
Это подчеркивает индивидуальную свободу и право каждого человека искать собственное счастье.
1. Индивидуальные права: Конституция и поправки акцентируют внимание на защите индивидуальных прав и свобод, что может способствовать личному счастью через самореализацию и защиту от произвола.

▎Конституция России:

1. Социальные права: Конституция РФ акцентирует внимание на социальных гарантиях, таких как право на труд, образование, медицинское обслуживание.
Это подразумевает, что государство должно создавать условия для достижения счастья.
1. Общие интересы: В российской Конституции больше внимания уделяется коллективным интересам общества, что может влиять на восприятие счастья как общего блага, а не только индивидуального.
...
Лучшие генеративные модели искусственного интеллекта от Google и китайских корпораций на момент публикации главы имеют схожее мнение.

То есть каждый человек стремится к Счастью, но в разных странах и культурах этот образ будет отличаться.
Это лишь напоминает нам о [непростой задаче нахождения единого образа Счастья](p1-010-happiness.md#cornerstone_of_text) и необходимости в [подходах понимания друг друга](p1-030-time.md#shared_vision).

В Штатах образ больше ассоциирован с правом материальной собственности и [чуть более эгоцентричен](p1-040-unhappiness.md#egocentrism).

У нас он чуть больше идеализирован общественным сознанием, а значит и властью.

Поэтому, зачем о Счастье говорить в конституции, когда оно воспринимается как общественное достояние?
...
Справедливости ради попробую переметнуться на другую сторону и опровергнуть свой же тезис о размере нашей страны.
...
Надо сказать, что расстояния у нас колоссальные, но вполне сравнимые с азиатскими.
...
[Павел Фокин](https://www.livelib.ru/quote/46256764-dostoevskij-glazami-sovremennikov){ .author }
...
![Яндекс и ВК в кружках справа посередине. Из национальных сервисов также видны китайцы](img/internet.jpg){ width="75%", loading=lazy }
/// caption
...
Думается, что сократить их влияние иногда помогало [следование Призванию](p1-020-call.md#calling).
...
Жду, когда количество таких вставок будет расти и начнут приходить Pull Requests непосредственно в GitHub, но радуюсь появлению этого дополнения как первому шагу коллективной работы.

Можно сказать, что пора завершать часть Наблюдений и переходить к Практической части построения Счастья! :-)
