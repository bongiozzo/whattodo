...
Когда это узнал, вспомнилось, что всегда с некоторым скепсисом относился к определению, что «Человек — социальное животное».

Позже нашёл полную версию высказывания, которая уже не была такой однобоко категоричной, а поддерживала разнополярные варианты.

/// quote

Человек по природе своей есть животное общественное, а тот, кто в силу своей природы, а не вследствие случайных обстоятельств живёт вне общества, — либо недоразвитое в нравственном смысле существо, либо сверхчеловек…

[Аристотель](https://www.livelib.ru/quote/552449-politika-aristotel){ .author }

///

Фраза Аристотеля в краткой форме не находила отклика, не потому, что отрицаю эволюционное происхождение видов и имею альтернативный взгляд.
Ни в коем случае!
...
Спустя пару лет после написания этой главы определил для себя Благоговение как ощущение присутствия Бога.
...
В комментариях к этой главе [рассказали историю об образе счастья](https://t.me/bongiozzo_discussion/920).
Приведу её тут же.
...
[Евгения Васич](p2-100-authors.md#capysv){ .author }
...
[Григорий Григорьев](https://www.livelib.ru/quote/48054208-veter-radosti-tri-dnya-v-lunnom-svete-grigorij-grigorev){ .author }
...
[Walter Beran Wolfe](https://ru.citaty.net/tsitaty/624212-u-beran-fulf-esli-vy-prigliadites-k-deistvitelno-schastlivomu-ch/){ .author }
...
![Детские воспоминания об управлении кораблём](img/ship.jpg){ width="100%", loading=lazy }
/// caption
...
### Предназначение или Призвание {#calling}
...
— Решение человека по переходу в другую компанию или продолжению работы в нашей зависит от 4-х факторов! — открыто говорили нам на onboarding-мероприятиях New Employee Orientation.
...
Игроки в RPG (а я играл в начале 2000-х в Baldur's Gate II) при создании персонажа определяют виды реакции персонажа на события в 2-х осях — Lawful-Chaotic и Good-Evil.
Получатся 4 квадранта с разными моделями поведения и склонностями к занятиям типа вор, воин, маг, клерик...

В реальной жизни с развешиванием ярлычков Добрый и Злой далеко не уедешь, но параллели с более сложными моделями поведения провести можно.
Ещё в 90-е, в начале своей рабочей деятельности, с большим интересом погрузился в Соционику — [советскую ветку практикума определения психотипов по методологии Юнга](https://ru.wikipedia.org/wiki/Типология_Юнга).
...
И это уже приличное многообразие, в котором можно что-то выбирать.

Несколько раз в разговорах встречал критику подобного подхода.
Объяснялось тем, что люди могут реагировать на одну и ту же ситуацию по-разному в зависимости от настроения или жизненных обстоятельств, но не психотипа.
И наука не жалует эти практики тоже — ведь такая типизация, действительно, не может быть точной.
И, вообще, человек — уникален, мир — бесконечен, «умом Россию не понять» и тому подобное.

Всё так.
Можно и так относиться.
Но это, на мой взгляд, позиция, которая оправдывает бездействие в работе с собой и с отношениями.
...
![Стратег-Архитектор с уклоном в планирование](img/architect.png){ width="100%", loading=lazy }
/// caption
Стратег-Архитектор с уклоном в планирование INTJ
///
...
Спустя несколько лет после теста 16 personalities на английском прошёл на русском.
С бинарными ответами Первый-Второй, а не градацией в процентах.

Выбирать ответы для большинства вопросов приходилось, практически, наугад — ответы были равнозначные за редким исключением, типа моего пола или «Что важнее — честность или гибкость?»
Тут [моя система принципов](p2-110-system.md) и [воля](p2-120-school.md#psychology_of_will) в следовании им пока выпячивается.

Оценка, по сути, подтвердила вывод предыдущего теста.
Так как значения в зоне 50% является целью и перевал на другую сторону является скорее погрешностью.

![Сбалансированный Наставник INFJ](img/mbti.png){ width="100%", loading=lazy }
/// caption
Сбалансированный Наставник INFJ
///

Радуюсь, что [практическая работа по сокращению собственной поляризации](p2-110-system.md#polarization) за годы написания этого Текста даёт результат.
Ведь основной смысл этой типизации в том, чтобы понять свою отправную точку и вектор для движения. 

И на мой взгляд, правильно, когда что-то выпирает :-)
Как минимум то, что в окружающем мире перекошено в обратную сторону.

Нужно же учитывать [«поправку на ветер»](p2-120-school.md#idealization).
...
Заранее составлять списки и планы — полезный навык.

Планирование своих действий при этом заранее формирует ожидания.
Стоит ли говорить, что зачастую, точнее практически всегда, всё идет не так, как планировалось?

Разрыв ожиданий и реальности, конечно же — частая и важная причина несчастий.
...
Предполагаю, что Цукерберг и братья Дуровы испытывали максимальный эмоциональный подъём именно в процессе создания своих миров, а не в моменте извлечения финансовых выгод.
...
А дети обожают светлый, весёлый, но глубокий [индийский фильм «Три идиота»](https://ru.kinorium.com/440193/).
...
Можно привести подходящие высказывания на этот счет:
...
[Генри Форд](https://www.livelib.ru/quote/47208539-moya-zhizn-moi-dostizheniya-s-sovremennymi-kommentariyami-genri-ford){ .author }
...
[Сократ](https://ru.citaty.net/tsitaty/651143-sokrat-zaglianite-v-svoi-sobstvennye-dushi-i-naidite-v-nikh/){ .author }
...
[Андрей Тарковский](https://www.livelib.ru/quote/48219430-italyanskie-marshruty-andreya-tarkovskogo-lev-naumov){ .author }

///

Но к этому моменту жизни, вероятно, и Радость больше испытываешь не столько от роста собственного материального достатка, сколько от благополучия своего окружения.

Ведь мы живем в обществе.
И учитываем ценности и взгляды окружения.

Между тем времена и ценности существенно меняются.
