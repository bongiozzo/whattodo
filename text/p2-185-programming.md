...
Но если поиск ошибки всё же засасывает в стрессовое состояние, то значит пора возвращаться в сбалансированное состояние и переключать фокус.
Затеять уборку, заняться физической нагрузкой, кто-то будет [медитировать](p2-110-system.md#practicing_meditation), мне ближе [помолиться](p2-110-system.md#nlp_and_pray).

Стараюсь [совмещать](p2-110-system.md#paradox)…
