...
Мой выбор опять же обусловлен [призванием программиста](p2-185-programming.md).
...
Наш Текст можно [редактировать в Obsidian](https://github.com/bongiozzo/whattodo#readme) — популярном редакторе личных заметок.
В описании продукта явно звучит целевой сценарий использования, который является основным и для Текста — создание цифрового образа своего сознания.

Есть другие редакторы в открытом коде, которые также поддерживают Markdown — вариантов много.
