...
И слово «Логос» с рацио корнем по смыслу соответствует сути [Программирования](p2-175-programming.md) — Текст совершает Действия.
...
Мой выбор опять же обусловлен [призванием программиста](p2-175-programming.md).
...
В перспективе для работы с Текстом планирую использовать собственные вычислительные мощности, для чего был создан ещё один forge — [thunder-forge](https://github.com/shared-goals/thunder-forge).
А пока решение не готово, вместе с Gemini Pro 3.1 из коммерческой подписки Copilot Pro создали [краткое изложение магистральной идеи в отдельной главе Приложения](p3-summary.md).
Модель Gemini Pro вместила весь Текст в своё контекстное окно и не шалила.

Решил такие результаты генерации на базе Текста складывать в отдельный раздел сайта «ИИшная»
:-)
Текст других разделов рождался исключительно в моём мозгу.
