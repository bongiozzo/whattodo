...
Наш Текст вполне можно редактировать в Obsidian – инструменте ведения личных заметок.
...
Поэтому сделали вместе с оплаченной из моей подписки моделью Gemini Pro 3.1, которая в состоянии поместить весь Текст целиком в контекстное окно, [краткое изложение магистральной идеи в отдельной главе Приложения](p3-summary.md).

Такие ИИ генерации на базе Текста буду складывать в раздел сайта «ИИшная» :-)

Неожиданно клёвый, развёрнутый ответ, близко к источнику, вернул сервис мятежного миллиардера.

[Судите сами](https://grok.com/share/c2hhcmQtMw_6157cb6d-0292-466c-8567-149222baf47c?rid=90be0f4e-4931-40d7-9d2c-012a09534a4a).

Поэтому заменил ссылку с робота в правом верхнем углу на использование Grok.

/// abstract | Предупреждение!

Не забывайте, что даже если LLM не врёт, действительно вгрузил весь текст в контекстное окно и не выкинул 90% информации, будут ошибки прочтения.

Так, например, я заметил в его пересказе упоминание о пережитом мною разводе! :-)

Задал уточняющий вопрос и Grok извинился, сославшись на то, что в Тексте упоминаются не только ванильно-радужные моменты счастья и радости, которые им были восприняты как развод.

Впрочем, это и неудивительно, развод в нашем обществе скорее норма, чем исключение. 

///

Этот раздел в прошлой версии, которая останется в истории git, назывался РазумИЙ.
