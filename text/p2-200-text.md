...
А когда электронная почта перестала быть основным средством коммуникаций и Outlook уже стал не нужен, задачи переехали в Google Keep, а потом и вовсе в [Telegram](p2-180-sharedgoals.md#telegram_principles).

Сейчас пишу задачки и планы в Telegram с разными тегами, которые можно использовать для сообщений в папке Избранное.
Этот же подход будет основным в работе с ИИ помощниками.
