...
На житейском уровне это утверждение проверяю «от обратного» — когда кто-либо даёт Слово, но потом никакого Дела не происходит, когда нет связи между идеей и реализацией — рушатся ожидания, [вера пропадает](p2-120-school.md#psychology_of_belief).
