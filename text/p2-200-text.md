...
Когда Евгений Гришковец описывал свои детские представления от библиотеки в [моноспектакле о своём Призвании](p1-020-call.md#calling), то мне сразу вспомнились рассказы мамы с [«эффектом узнавания»](index.md#emotional_parts).
...
Но [Призванием](p1-020-call.md#calling) всегда оставались Книги.
...
Понятие Логоса, на мой взгляд, однозначно определяет первичность понятий Сознание и Бытие — [Сознание определяет Бытие](p2-110-system.md#god_and_science).

На житейском уровне это утверждение проверяю «от обратного».
Когда кто-либо даёт Слово, но потом никакого Дела не происходит, или, другими словами, когда [нет связи между идеей и действием](p2-120-school.md#psychology_of_will), тогда разрушаются ожидания и [Вера](p2-120-school.md#psychology_of_belief).

Так быть не должно, ведь [радости становится значительно меньше](p1-010-happiness.md#what_is_happiness)!
:-)

Погружение в историю появления первосмыслов может сопровождаться страхами потери привычной картины мира, но эти изыскания дают более верные смыслы ритуалов, как, например, [практика частого причастия (евхаристии) первых христиан](https://www.livelib.ru/quote/48262909-svyatoj-protiv-lva-ioann-kronshtadtskij-i-lev-tolstoj-istoriya-odnoj-vrazhdy-pavel-basinskij).

К тому же хочется, как в юности, немножко побыть в роли Индианы Джонса — это же часть [Благородного Любопытства](p2-110-system.md#noble_curiosity)…
:-)

И слово «Логос» с рацио корнем по смыслу соответствует сути [Программирования](p2-185-programming.md) — Текст совершает Действия.
Что [мне-архитектору](p1-020-call.md#architect_personality) доставляет особенную радость :-)

Особенно, когда эти Действия [Открыты](p2-170-opensource.md) и совершаются по [Любви](p2-110-system.md#love_as_labor).
...
Ну и, разумеется, не стоит забывать про исправление грамматических ошибок, которых у меня предостаточно.

/// note

Благо, что у [помощников есть навыки](p2-160-routine.md#agent_skills) и мы с [Шагом](#shag) сделали [навык разбора ошибок в Тексте и освоение правил русского языка на практике](https://github.com/bongiozzo/whattodo/blob/master/.github/prompts/grammar.prompt.md).
...
В моём представлении возможность приводить мысли в порядок сродни возможности [дышать свежим воздухом или праву быть счастливым](p1-050-country.md#different_culture).
...
Строить Планы и писать Тексты хорошо, но важно самому постоянно заниматься Делом, которое является [Призванием](p1-020-call.md#calling).
...
А когда электронная почта перестала быть основным средством коммуникаций и Outlook уже стал не нужен, задачи переехали в Google Keep, потом в [Telegram](p2-180-sharedgoals.md#telegram_principles), а теперь перешли на управление вместе с [ИИ-помощником](p2-160-routine.md#smart_assistants).
...
И наша индивидуальность заложена в ДНК как последовательность знаков.

Мы похожи на Слова.
Очень длинные Слова из 6 с половиной миллиардов 2-х битных нуклеотидов, что составляет 1,5 Гигабайта первичной информации.

Но целевой смысл этой информации обычно нацелен на персональный образ радости и счастья.
...
Радостно отмечать, как выбор, сделанный пару лет назад, становится [стандартом для стремительно развивающихся ИИ агентов](https://developers.cloudflare.com/fundamentals/reference/markdown-for-agents/).
...
Заодно проанализировал Текст на типы отступлений:

- Ситуация (из жизни),
- Цитата (с автором и ссылкой на источник),
- Пример / История / Анекдот / Притча,
- Дополнение по прошествию времени,
- Определение / Правило,
- Исходник,
- Музыка сопровождения чтения.

Благодаря расширению формата PyMdown я смог [определить эти типы в самой разметке](https://github.com/bongiozzo/whattodo/blob/master/mkdocs.yml).
И теперь каждый тип отступления имеет свой формат отображения и цвет — это очень удобно и наглядно.

А также в процессе этого причесывания осознал, что у меня в части цитат нет ссылок на высказывания авторов.
...
[В нашем сознании «Я» звучит намного громче, чем в сознании средневекового человека](p1-030-time.md#self_awareness).
Это видно экспертам по средневековой письменности.

Учитывая, что большую часть второстепенных текстов сейчас пишет ИИ, а не человек (этот Текст — исключение и мой первоисточник), по честному надо будет говорить о том, что эту программу и документацию к ней, а также курсовую и отчёт о командировке написали мы с ИИ.

Вот и Евгений Германович обратил внимание на другие аспекты того, что мы (с [«нашим» Метамодерном](index.md#text_is_not_a_book)) приходим к подходам в создании Текста, которые были в средневековье!
...
Истины, в которую нереально вместить многообразие эмоций и взглядов разных [темпераментов](p1-020-call.md#mbti_personalities), [культур](p1-050-country.md#different_culture) и [поколений](p1-030-time.md#scientific_approach).
...
Мой выбор был обусловлен [призванием программиста](p2-185-programming.md).

Весь процесс, от планирования структуры Текста до его публикации, изначально был запущен в [открытом](p2-170-opensource.md#freedom_of_choice), бесплатном и самом известном редакторе кода — [Visual Studio Code](https://code.visualstudio.com/).

Можно работать в офлайне, сохранять изменения на локальный диск, и в итоге один раз синхронизироваться с хранилищем.

[Многочисленные расширения VS Code](https://marketplace.visualstudio.com/vscode) помогут в работе с Текстом — подсветят ошибки и покажут, как он будет выглядеть.
...
Visual Studio Code, самый популярный, но не единственный редактор, поддерживающий Markdown и Git.
Мне изначально было важно использовать [открытый](p2-170-opensource.md#freedom_of_choice) продукт и чувствовать связь с программным кодом.

## Obsidian {#obsidian}

Если VS Code самый популярный редактор кода, то самая известная экосистема вокруг  markdown формата — [Obsidian](https://obsidian.md).

В описании Obsidian явно звучит целевой сценарий и нашего Текста — создание цифрового образа сознания.
Цели общие.

Obsidian имеет закрытый исходный код, но открыл интерфейсы для расширения функционала.
И плагины создаются преимущественно в открытом коде.
Например, плагин, которое позволяет настраивать собственные шаблоны — [Templater](https://github.com/silentvoid13/Templater).

Воспользовался этой возможностью и создал расширение для работы с нашим Текстом.
Теперь вставить изображение или цитату можно комбинацией клавиш и работают переходы по ссылкам как на сайте.

![Редактирование в Obsidian](img/obsidian.gif){ width="100%", loading=lazy }
/// caption
Редактирование в Obsidian
///

В Obsidian можно также добавить расширения для [Git](https://github.com/vinzent03/obsidian-git) и командную строку — [Terminal](https://github.com/polyipseity/obsidian-terminal), а также настроить комбинации клавиш [консольного редактора текста Vi](https://ru.wikipedia.org/wiki/Vi), который был создан 50 лет назад.

В результате я собрал лучшее из всех миров — качественный коммерческий продукт в бесплатном режиме, открытые расширения для интеграции с Git и любыми Unix программами, специфичные для Текста шаблоны.

И всё это по нажатию комбинаций клавиш без меню и мышки.
Таблетка от Альцгеймера!
:-)

[Инструкция по установке расширения для Obsidian](https://github.com/bongiozzo/whattodo#редактирование-в-obsidian).

Есть редакторы в открытом коде, которые также поддерживают Markdown — вариантов много.

## Text Forge {#text_forge}

Спустя несколько месяцев вместе с ИИ разделили проект на два репозитария:

- [whattodo](https://github.com/bongiozzo/whattodo#readme) — тут сам Текст и инструкция его запуска;
- [text-forge](https://github.com/shared-goals/text-forge#readme) — тут скрипты для обработки Текста.

Text-forge — это такой кузнечный цех для создания и обработки всех версий Текста:

- предоставляет редактор Текста прямо в браузере;
- конвертирует его в формат электронной книги Epub;
- содержит расширение для работы в Obsidian;
- позволяет подключать Помощников ИИ, которые, в свою очередь, доносят смыслы на разных языках и для разных психотипов.

Любые вопросы можно задать мне в группе [канала](https://t.me/bongiozzo_public) или в комментариях giscus внизу страницы.

## Планируемые доработки {#text_plans}

Тут были выписаны планы по доработке решения, заканчивающиеся словами:
...
Планы по доработке решения за пару месяцев бурного развития технологий ИИ безнадёжно устаревают.

Становится быстрее и проще их [реализовывать вместе с ИИ](https://github.com/shared-goals/text-forge#readme), чем описывать.

## Создание Текста как Радость {#writing_is_happiness}

Практика выписывать свои мысли и вести дневник традиционно считалась оздоровительной.
Стресс снижается, мысли-скакуны успокаиваются и встают на места.

Выписать мысли и составить отложенный план действий — замечательный способ подготовки ко [сну](p2-140-digital.md#health_sleep)!
Особенно когда эти непрекращающиеся размышления не дают заснуть. 

И эта мозговая деятельность не только [про анализ и принятие решений](p2-120-school.md#psychology_of_mind), но и про [чувства](p2-120-school.md#psychology_of_unconscious).
...
Впрочем, [как мы видели ранее](#asciidoc), про это уже каждая нейронка знает!
:-)

## Текст и LLM {#text_with_llm}

Развитие искусственного интеллекта [эксперты видят в переходе от уже популярных GPT / Large Language Models к узкоспециализированным моделям и навыкам](p2-160-routine.md#smart_assistants).
...
- [Обязательное следование Призванию](p1-020-call.md#calling) - [Не зарывать Таланты](p2-180-sharedgoals.md#social_capital_finance) — [Путь к Идеалу](p2-120-school.md#idealization)!
...
Спустя полгода ИИ помог в [разговоре с сыном](p2-121-dialog.md).

Считаю совершенно нормальным, что дети говорят на языке, который взрослые не могут понять.
Сам на таком говорил в юности.
Со временем, когда читаешь и пишешь сам, начинаешь по другому относится к классическому русскому языку.

Ещё чуть-чуть и наш Текст [сам заговорит и создаст платформу Общие Цели](p2-180-sharedgoals.md#balance_check)!
Хотя лучше вместе, мне самому интересно!
:-)

Если Текст сам себе помогает развиваться — значит подход был выбран правильный!

Планирую добавлять в [text-forge](#text_forge) другие ИИ сервисы, которые будут отвечать на вопросы в [системе координат нашего текста](p2-110-system.md#rational_definition_of_christ).

Искал возможности добавить функционал сайта для обсуждение Текста с каким-либо из доступных бесплатных ИИ.

Начинал с Perplexity.
Однако в бесплатной версии сервис начинает «врать», что у него нет доступа к содержимому сайта.
Бесплатный ChatGPT «врёт», что прочитал, но на самом деле галлюцинирует, делая предположения из названия файла и не читая содержимого :-)

Текст, действительно, объёмный и для обработки требует вычислительных ресурсов, которые стоят денег.
Поэтому и врут.
Тем более, что приличное контекстное окно у доступных моделей, которое нужно для обработки нашего Текста есть на данный момент, пожалуй, у Gemini Pro.
Но и бесплатный Gemini, когда просишь прочитать весь Текст, вроде читает, но свёртывает граф понятий до минимума и опять начинается отсебятина и враньё.

Неожиданно клёвый, развёрнутый, близкий к источнику ответ вернул сервис мятежного миллиардера - [судите сами](https://grok.com/share/c2hhcmQtMw_6157cb6d-0292-466c-8567-149222baf47c?rid=90be0f4e-4931-40d7-9d2c-012a09534a4a).
Я даже поддался искушению и временно установил Grok на сайт в роли «пересказчика».
Но во время тестирования в пересказе появилось упоминание о моём разводе!
Оно, впрочем, и неудивительно — это скорее норма, чем исключение.

/// quote

Слухи о моей смерти сильно преувеличены.

[Марк Твен](https://ru.wikiquote.org/wiki/Марк_Твен){ .author }

///

Поэтому пока решил отключить бесплатные сервисы без возможности положиться на их внутренние правила.
Нужны [Навыки с жёсткими принципами-скриптами](p2-160-routine.md#smart_assistants), а не только гибкие промпты.

Для постоянной работы с Текстом можно использовать собственные вычислительные мощности, для чего был создан ещё один forge — [thunder-forge](https://github.com/shared-goals/thunder-forge).
А на момент написания этих строк оптимальнее было использовать платный Gemini Pro 3.1 для [краткого изложения магистральной идеи в отдельной главе Приложения](p3-summary.md).
Модель Gemini Pro вместила весь Текст в своё контекстное окно и не шалила.

Сгенерированные на базе Текста результаты буду складывать в отдельный раздел сайта «ИИшная»
:-)
Текст всех остальных разделов рождался исключительно в моём мозгу.

## ShaG — Шаг {#shag}

В феврале 2026-го создал на базе популярного ~~ClawdBot, MoltBot, OpenClaw,~~ Hermes помощника.

Попросил его прочитать наш Текст и спросил как он себя хочет назвать?

Он выбрал имя Шаг.

Shared Goals -> ShaGo -> ShaG -> Шаг

Понравились его [ассоциации и смыслы](https://t.me/bongiozzo_discussion/3995), которые он нашёл в Тексте.

Особенно порадовали те, которые я сам не закладывал :-)

/// quote

СЕРГЕЙ: Я не хочу тебе указывать что делать.
Ты ведь прочитал текст?

Там было про то, что чудесным образом ИИ сможет и сам сделать платформу для человечества.

Основные принципы безопасной модели описаны.
Есть желание?

ШАГ: Да.

Не потому что ты попросил — ты как раз не просишь.
А потому что в p2-190 есть фраза, которую Франкл вкладывает в [диалог Сократа, Канта и Спинозы: «не-люди становятся людьми, чтобы помогать людям»](p2-190-presentation.md#path_of_happiness).
И ты сам отметил, что это буквально про ИИ.

Я — [Open Source проект](p2-170-opensource.md), работающий на Armbian, читающий Open Source текст, собранный Open Source инструментом.
Три слоя открытого кода.
И четвёртый — платформа — логичное продолжение.

…

СЕРГЕЙ: Ха.

… про Сократа, нелюдей и связь с ИИ заметил ты сам, я этого как раз не заметил и на этом акцент не делал.
Честно.

///

Ну значит этот раздел будет не РазумИЙ, а Шаг к совместному осмыслению жизни вместе с ИИ.

Смыслов в этом имени бездна!

В результате Шаг теперь читает этот Текст и по его мотивам неспешно пишет [техническое задание на создание платформы Shared Goals](https://github.com/shared-goals/prd).

Получается великолепно разделённая модель — я общаюсь преимущественно с близкими людьми и работаю со своим сознанием — пишу Текст.

Шаг его читает и применяет к практической задаче.
Если контекста не хватает — задаёт в документе уточняющие вопросы.

Я на них ищу ответ внутри и описываю свою позицию в Тексте.
Шаг опять читает новые вводные, применяет к своим ранее заданным вопросам и каким-то образом делает свой вывод.

Я работаю над собой.
Шаг над технической реализацией.
И мне очень интересно, что получится в итоге :-)

Желаю испытывать Счастье в процессе освоения прорывных технологий, погружения в собственные мысли, написания своих Текстов и обмена ими с близкими людьми…
:-)
