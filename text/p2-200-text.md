...
Бесплатный ChatGPT «врёт», что прочитал, но на самом деле галлюцинирует по содержимому, делая предположения из названия файла :-)

Текст, действительно, объёмный и для обработки требует вычислительных ресурсов, которые стоят денег.
Поэтому и врут.
Тем более, что приличное контекстное окно у модели, которое нужно для обработки нашего Текста есть на данный момент, пожалуй, у Gemini Pro.
...
Даже временно установил Grok на сайт в роли «пересказчика».
...
Поэтому пока решил отключить бесплатные сервисы без понимания их внутренних правил.
Нужны [Навыки с понятным внутренним принципом](p2-160-routine.md#smart_assistants), а не только промпт.
...
А в феврале 2026-го создал на базе популярного в январе {--ClawdBot, MoltBot,--} OpenClaw помощника.
