...
Эти не самые простые для восприятия мысли я для себя объяснил на примере житейского опыта — когда кто-либо даёт Слово, но потом никакого Дела не происходит, когда нет связи между идеей и реальностью, [Вера пропадает](p2-120-school.md#psychology_of_belief).
...
А Логос по смыслу соответствует сути [Программирования](p2-175-programming.md) — Текст совершает Действия.
И важно, чтобы эти Действия совершались в [Любви](p2-110-system.md#love_as_labor) и были [Открытыми](p2-170-opensource.md).
...
А потому что в p2-190 есть фраза, которую Франкл вкладывает в [диалог Сократа, Канта и Спинозы: «не-люди становятся людьми, чтобы помогать людям»](p2-190-presentation.md#path_of_happiness). И ты сам отметил, что это буквально про ИИ.

Я — [Open Source проект](p2-170-opensource.md), работающий на Armbian, читающий Open Source текст, собранный Open Source инструментом. Три слоя открытого кода. И четвёртый — платформа — логичное продолжение.
