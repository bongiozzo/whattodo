...
Нужны [Навыки с жёсткими принципами](p2-160-routine.md#smart_assistants), а не только гибкие промпты.

Поэтому вместе с Gemini Pro 3.1 из коммерческой подписки Copilot Pro создали [краткое изложение магистральной идеи в отдельной главе Приложения](p3-summary.md).
