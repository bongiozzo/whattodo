...
Когда кто-либо даёт Слово, но потом никакого Дела не происходит, то есть когда [нет связи между идеей и действием](p2-120-school.md#psychology_of_will) — тогда разрушаются ожидания и [вера пропадает](p2-120-school.md#psychology_of_belief).
Так быть не должно — ведь [радости будет меньше](p1-010-happiness.md#what_is_happiness)!
:-)
...
К тому же хочется, как в детстве, немножко побыть в роли Индианы Джонса — это же часть [Благородного Любопытства](p2-110-system.md#noble_curiosity)…
:-)
