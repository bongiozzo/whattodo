...
Есть Logseq в открытом коде, который также поддерживает Markdown, но нацелен больше на списки, буллеты и задачи.
Вариантов работы с текстом в Markdown много.
