...
Библиотека этих программных компонентов является частью [инициативы «Shared Goals» (или «Общие Цели»)](https://text.sharedgoals.ru/ru/p2-180-sharedgoals/#use_case).
