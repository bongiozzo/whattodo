...
Друзья при обсуждении мыслей и содержания этого текста предлагали писать подкасты или записывать видео. Тем более, что технологии преобразования звука в текст уже встроены в мессенджеры и видео платформы. Но в моем случае, создание текста как первоисточника — рациональный процесс упорядочивания мыслей и основной канал получения информации. К тому же, я довольно косноязычен и мне неминуемо будет стыдно за бесконечные "Там" и "Эээ". И если потом потребуется другой формат — из текста его можно будет сделать в любой момент. Текст как начало. Текст как продолжение. Мир как текст.
