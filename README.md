...
## Здравствуйте!<a href="#hello" id="hello"></a>
...
Друзья при обсуждении мыслей и содержания этого текста предлагали мне писать подкасты или записывать видео. Тем более, что технологии преобразования звука в текст уже встроены в мессенджеры и видео платформы. Но в моем случае, создание текста — рациональный процесс упорядочивания мыслей и основной канал получения информации. К тому же, я довольно косноязычен и мне неминуемо будет стыдно за бесконечные "Там" и "Эээ". И если потом потребуется другой формат — из текста его можно будет сделать в любой момент.

Забавно, что при обсуждении этого текста с друзьями зачастую звучало и звучит слово Книга, как привычный формат текста. Я и сам иногда оговариваюсь, но одергиваю себя и поправляюсь. Дело в том, что книга — это конечная история. У этого текста я пока не могу обозначить границы. Кроме того, книга воспринимается как монолог автора, а моей целью является коллективно созданный материал, где авторство уже не так важно. Поэтому видится скорее набор небольших публикаций-лонгридов в небольшом сообществе любопытствующих, неравнодушных людей, как дань эпохе метамодерна.
...
- [Автор этого текста — дотошный и ленивый зануда.](#hello)
- [Пишет текст, чтобы систематизировать систему взглядов для разговоров с близкими, но при этом не повторяться.](#text_idea)
- Предпочитает опробовать идеи на практике и не любит их откладывать в долгий ящик.
- С фантазией у автора "Не очень", придумать оригинальное название не в состоянии, взял известное произведение и добавил "смайл" в конце.
- Для читателей этого списка попытался рассказать, почему он не ограничился краткими выводами, а описывает свои эмоции и делится воспоминаниями.
- Здесь и далее — каждый раз когда кто-либо называет этот Текст книгой, автор исправляет.
- Потому что не определился — когда материала будет достаточно и когда Текст будет завершен.
- При всём при этом, автор ещё пытается вовлечь в написание этого Текста соавторов.
- Опубликовал Текст в github, публикует его по главе и ждет критических мнений и комментариев.
