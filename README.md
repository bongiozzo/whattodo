...
# В качестве вступления <a href="#intro" id="intro"></a>
...
![Я тот, что в чёрной шапке. Быть душнилой иногда заразно!](.gitbook/assets/dushnila.jpg)
...
## Что мне делать? :-) <a href="#what_should_i_do" id="what_should_i_do"></a>
...
## Эффект узнавания <a href="#emotional_parts" id="emotional_parts"></a>
...
## Текст — не Книга <a href="#text_is_not_a_book" id="text_is_not_a_book"></a>
