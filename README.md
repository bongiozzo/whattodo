...
<summary href="#summary" id="summary">Краткие тезисы по главе</summary>
...
- [Так как автор пытается вовлечь в написание соавторов и для этого опубликовал текст в GitHub и ждет критических мнений и комментариев.](#text_as_dialogue)
