...
[Obsidian](https://obsidian.md) – пожалуй, самый распространённый редактор Markdown текста.
С помощью плагина [Templater](https://github.com/SilentVoid13/Templater) можно настроить быструю вставку внутренних ссылок, преднастроенных блоков и назначить на них горячие клавиши.
...
3. Добавляет Templater в список плагинов (`.obsidian/community-plugins.json`).
...
Если перед вызовом команды выделен текст, он по умолчанию станет содержимым блока.
