...
- [Автор начинает с того, что тяжелая музыка является настолько абсурдной и чрезмерной по сути, что напоминает Юмор.](#absurd_as_salvation)
...
- [Смешение нескольких увлечений может иметь причудливые формы, например, программист и диджей экстремальной передачи на радио.](#radio_lightning_strike)
- [Появление Интернет создало новую форму на стыке увлечений музыкой и программированием — сайт, который стал объединять фанатов.](#musica_mustdie)
- [Автор погружается в рефлексию о противоречиях известных музыкантов, которые объединили в себе полюсы.](#people_with_opposite_poles)
...
- [Благодаря тяжёлой музыке появились друзья, сформировалось мировоззрение и случились тысячи моментов Счастья.](#heavy_music_and_happiness)
