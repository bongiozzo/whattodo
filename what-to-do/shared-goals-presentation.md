---
description: >-
    Сжатый пересказ предыдущей главы и всего Текста "Что делать? :-)" с визуальным рядом. Презентация со ссылками на заметки, отражающие мировоззрение.
---
...
формируются навыки, которые помогают проходить эти кризисы и начинают работать как Генератор моментов счастья. Причем мыслители
...
## 21. Что делать? :) <a href="#what_to_do" id="what_to_do"></a>

![Что делать? :)](../.gitbook/assets/slideWTD.png)
