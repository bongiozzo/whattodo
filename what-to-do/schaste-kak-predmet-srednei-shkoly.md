...
- [Счастье, как предмет средней школы](#happiness_model)
...
- [Что делать для сопротивления новым зависимостям? Рисовать :-)](#draw_and_animate)
