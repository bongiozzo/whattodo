...
- [Первая глава второй практической части текста. До этого был анализ причин и следствий феномена Счастья, теперь автор делится опытом.](#practicing_happiness)
- [Автор проводит параллели в истории России, когда рушились привычные системы ценностей и общество расходилось на враждующие лагеря.](#again_and_again)
- [Автор не занимает позицию диванного аналитика в роли "Кто виноват?", но выступает противником крайних полярных суждений. Начиная и заканчивая собой.](#polarization)
- [И в качестве фундамента для Счастья предлагает персональную сбалансированную позицию из двух полярных векторов — провокационно, Бог и Наука.](#god_and_science)
- [Раскрывается идея об объединении этих начинаний внутри как одно из объяснений смысла жизни Человека. Идее Максима Исповедника более 1300 лет.](#dualism)
- [Автор верит, что поддержание внутри себя баланса этих начинаний сокращает вероятность потенциальных конфликтов в обществе.](#dualism_for_peace)
- [Сбалансированная реакция на внешние события достижима в единой системе ценностей и Принятии разных проекций на нее.](#acceptance)
- [Автор пускается в поиски Бога в себе, анализ Символа Веры и определения системы ценностей в Интернет, но вязнет в догмах и не находит отклика.](#finding_god)
- [Находится современная трактовка христианских ценностей в контексте нашего времени. Запускается рефлексия на основе этой системы.](#rational_definition_of_christ)
- [Критическое Мышление переименовывается в Благородное Любопытство, которое не предполагает компромиссов с совестью.](#noble_curiosity)
- [Уточняется широкое понятие Любви. Как вектор приложения усилий, не предполагающий Долженствования и не имеющий противодействия.](#love_as_labor)
- [Подчеркивается ключевая идея христианства в отождествлении человека с Богом через создание его по образу.](#human_as_god)
- [Обращается внимание на схожесть ожиданий от жизни после Смерти в христианстве и формировании амбициозных Целей больше жизни в лидерском коучинге.](#larger_than_life)
- [Приводится краткая справка по концепциям Кови и Миллмана и их схожесть с христианскими ценностями.](#successful_salesmen)
- [Совсем уж практическая работа над формированием персональной системы ценностей начинается, как ни странно, с истории про медитацию.](#practicing_meditation)
- [Объясняется как от медитаций произошел переход в осознанное и частое чтение молитвы "Отче Наш".](#our_father)
- [Автор поделился своими ассоциациями и образами по каждой строчки молитвы. И даже вспомнил про НейроЛингвистическое Программирование.](#nlp_and_pray)
- [Утверждается, что эта практика запускает сдвиги в сознании и следом — в жизни. И подступается к самоопределению и приоритетам.](#refining_priorities)
- [Также с благородным любопытством анализируется система ценностей христианской семьи и вносятся корректировки в свои приоритеты.](#family_priorities)
- [На сегодня приоритеты автора - Муж, Отец, Программист, Предприниматель, Фотограф с ценностями Православного. Также приводятся ссылки на книги.](#books_about_love)
- [Похоже, что автор устал от собственного занудства и оборвал текст главы сомнительной цитатой и фотографией с друзьями и выпивкой, когда он был счастлив.](#stop_it)
...
## Поляризация — маятник. Искать баланс. <a href="#polarization" id="polarization"></a>
...
Мне видится, что исторический маятник колоссального эксперимента, запущенного Карлом Марксом словами — “Бытие определяет Сознание”, двигается в обратную сторону — “Сознание определяет Бытие”. Тут найдется о чем поговорить и я кратко уже вспоминал как [нас настиг маятник западного постмодерна в 80е, хотя мы же сами раскачивали маятник мировой революции в начале прошлого века](../analysis/strana.md#russia_in_new_history), и про миллениалов и наступающее время метамодерна с поиском утраченных смыслов. И, на мой взгляд, эти приоритеты и векторы для себя лично и общества вокруг могут звучать как:
...
Если совсем упрощенно, то Бог и Наука :-) Или Вера и Наука. Улыбку поставил, потому что явственно слышится критическая волна протеста, прежде всего внутри себя-рационала-логика-айтишника, с которой придется разбираться. И такая болезненная реакция, скорее всего, подсказывает, что это и есть правильная точка приложения усилий в работе над собой.

{% hint style="info" %}
Лет десять назад уже испытывал усталость от всех этих информационных систем, которыми занимался всю жизнь и даже назвал тот кризис фразами "Отойти от IT" и "Выйти из IT", которые очень комично звучат, если их произносить в разговоре :-)
{% endhint %}

## Дуализм <a href="#dualism" id="dualism"></a>

Нет внутри меня сомнений, а в моем окружении людей, которые были бы против тезиса о необходимости развития интеллекта и навыков мышления. [Даже если этот бесконечный процесс сравнения и анализа может уводить нас от состояния счастья или высокого эмоционального тона](../analysis/stereotipy-schastya.md#intelligence_quotient). Но вот рядом стоящий тезис о возврате к Вере и богоцентричному миру, скорее всего, вызовет вопросы. Ну, у меня совершенно точно вызывал и продолжает вызывать. И значит надо убирать из головы все стереотипы — весь тот хлам, который пришел от поляризованного информационного общества и самому с ним разбираться.

Глава эта в набросках ждала своего часа несколько месяцев, пока в одном из диалогов не получил [ссылку на видео с таким же названием](https://www.youtube.com/watch?v=0UhWxmoCYbs). И хоть я совершенно не подготовлен, чтобы углубляться в рассуждения о связи квантовых запутанностей и Бога, но даже я понимаю — что не в квантах дело и нельзя упрощать постановку вопроса до уровня — Гагарин в космос летал и Бога не видел. В этом видео вызвало уже привычную аллергию упоминание диктора о "навязанном" нам постмодерне и потребительском отношении и остается надеяться, что речь шла о предыдущих поколениях, а не о "мировой закулисе", которая позиционировалась как причина наших бед. Сами мы выбирали новые системы ценностей в [новой](../analysis/strana.md#russia_in_new_history) и [новейшей истории](../analysis/strana.md#newest_history) и нести ответственность за последствия можем только мы сами.
...
[Стивен Кови со своими навыками](https://www.livelib.ru/review/3792199-sem-navykov-vysokoeffektivnyh-lyudej) или другой американский писатель-коуч Дэн Миллман, создавший книги и [фильм о пути Мирного Воина](https://www.kinopoisk.ru/film/87161/), в которых сформулировано три принципа, эксплуатируют схожие ценности и модели, которые исключают ожидания исполнение Долга в свою сторону, что предполагает Любовь. Или которые снимают корону с Я центричного восприятие мира:
...
Поиск этой системы ценностей тоже можно назвать теоретизацией, а в этой части текста заявлялась практическая работа. И практика по развитию в себе духовного идеала в христианской системе ценностей начинается с работы над собой, с молитвы. Хотя, пожалуй, опять стоит начать с места чуть пораньше.
...
Не стоит и говорить, что молитва работает — настрой в целом улучшается когда искренне благодаришь за всё хорошее, что тебя окружает. Когда ты по 3 раза в день напоминаешь себе про разряженную батарейку и другой темперамент у человека, с которым поругался — становится легче. Или в которой раз искренне попросил помощи удержать тебя от какой-нибудь пагубной зависимости и когда рука уже тянется снова — вспоминаешь о своих просьбах, бросаешь взгляд внутрь и понимаешь, что зависимость ослабла. Подход работает! Правда обычно просыпается какой-нибудь другой бесёнок :-)
...
Когда начинаешь несколько раз в день всерьез вкладывать глубокие смыслы в слова и отправлять их наверх, неминуемо начинается переосмысление  другие вопросы, которые требуют определенности.
...
## А при чем тут счастье и его количественная модель? <a href="#stop_it" id="stop_it"></a>
