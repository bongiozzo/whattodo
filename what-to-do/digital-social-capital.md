...
[2 года как идёт заметное переосмысление ценностей. И в истории России это уже случалось далеко не первый раз. И каждый раз страна выходила на новый уровень](./personalnaya-sistema-cennostei.md#again_and_again).
...
![Моменты Счастья](../.gitbook/assets/slide7.png)
...
- можно формулировать измеримые и понятные цели для общества, напрямую связанные с интересами граждан и влиящими на их счастье впоследствии.
