...
В информационное поле изредка пробиваются психологи, коучи и другие эксперты со своими тренингами. Каждый зарабатывает по своему и такая работа тоже нужна. Однако хочу отстроится и обозначить основное отличие. Изначально не думал продавать что-либо — книгу, тренинг, продукт или сервис. Интересна критика и диалог в поиске ответа на вопрос «Что делать?». Важно самому разобраться, а не продать что-либо :-)
...
## Смерть как неизбежный финал <a href="#funeral_as_result" id="funeral_as_result"></a>
