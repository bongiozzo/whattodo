...
Это я к чему рассказал? Концентрация Воли и ощущение Ответственности, как мне кажется, неминуемо увеличивают это Я в мыслях и в речи. Когда что-то надо сделать, очень правильно сказать, что Я сделаю, а не Мы. Мы в этом случае срабатывает как лазейка, которую потом можно использовать, чтобы перенести ответственность за неудачу на кого-то другого. Очень правильно эту лазейку самому уметь закрывать в ситуациях проявления Воли и взятия Ответственности.
