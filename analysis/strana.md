...
{% hint style="info" %}
Идея этого текста заключается в коллективном его написании. Так создаются программы в концепции Open Source — Открытый код. И мне очень отрадно, что от друга "прилетел" первый готовый блок о Страхе.  

Глава звучит от лица Владимира Лобачёва, хотя я лично могу подписаться под каждой строчкой, не изменяя при этом авторского стиля.
{% endhint %}
...
Жду когда начнут приходить Change Request непосредственно в GitHub, но радуюсь появлению этой главы как началу коллективного творчества!
{% endhint %}