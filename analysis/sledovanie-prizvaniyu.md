---
description: >-
  Счастливая жизнь состоит из моментов счастья — когда они случаются? Большую часть жизни мы работаем, значит, чтобы достичь максимального интегрального счастья на всей протяженности жизни — надо получать удовольствие на работе, а значит — необходимо найти и заниматься любимым делом. Возможный способ определения рекомендаций по роду занятий.
---
...
## Примеры анализа ощущения и формулы счастья из комментариев

В комментариях к прошлой главе [прозвучал рассказ об образе счастья](https://t.me/bongiozzo_discussion/920). Приведу его тут.
...
![Стоишь за штурвалом, ветер в лицо, а впереди — море! Счастье...](../.gitbook/assets/forward.jpeg)

А [другой комментарий](https://t.me/bongiozzo_discussion/945) адресован уже к более взрослому и осознанному восприятию мира. К сожалению, с возрастом, как мне говорят старшие товарищи, уровень вырабатываемого дофамина значительно сокращается. И людям с преобладающим рациональным мышлением, чтобы оставаться счастливым, приходится искать что покрепче :-) Так появляются формулы и модели Счастья. И образ счастья в движении вперед, с открытой позицией к неизвестному и неизведанному изменился, но по сути остался тем же.
