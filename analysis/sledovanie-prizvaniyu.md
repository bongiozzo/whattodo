...
# 3. Следование призванию

<details>

<summary>Краткие тезисы по главе</summary>

- [Анализ феномена Счастья. Есть гипотеза, что ощущение предельного счастья умеют испытывать только люди, но не животные.](#sense_of_awe)
- [Приводятся примеры описаний моментов наивысшего Счастья от читателей и автора. Иногда совпадающие — движения в неизвестность.](#experience_of_happiness)
- [Чтобы получить наибольшее интегральное значение Счастья — испытывать его надо как можно чаще. Как? Найти любимую работу.](#frequent_happiness)
- [Для начинающих руководителей и специалистов по кадрам, вероятно, будут небезынтересны лучшие практики компании Microsoft.](#dream_job_checklist)
- [Можно подойти системно и определить наиболее приятный род занятий под собственный темперамент (психотип). Ведь все разные.](#mbti_personalities)
- [Автор признается, что чаще всего испытывал счастье в процессе проектирования информационных систем, что соответствует его психотипу.](#architect_personality)
- [Также даны примеры из литературы и кинематографа о важности Следования Призванию для достижения Счастья и Счастливой Жизни.](#follow_your_calling)
