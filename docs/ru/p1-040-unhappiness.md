...
Не хватает в рутинной городской жизни ощущения соприЧастия себя, маленькой и незначимой частички, к бесконечному и прекрасному миру — [редкое ныне чувство Благоговения](p1-020-call.md#sense_of_awe). А это значит, что мы не дополучаем положенные нам природой моменты Счастья :-)
