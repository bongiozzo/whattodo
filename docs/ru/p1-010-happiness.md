...
# Счастье как смысл жизни <a href="#happiness_as_life_goal" id="happiness_as_life_goal"></a>
...
![Через 5 минут после этого снимка машина намертво застрянет в грязи, вызволять её будем с женой и сыном несколько часов, а потом будет мощнейший Момент Счастья](../.gitbook/assets/leaf.jpg)
