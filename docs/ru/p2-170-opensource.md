...
# Open Source — свобода в движении к Любви <a href="#open_source_free_way" id="open_source_free_way"></a>
...
- [Мы живём, чтобы быть счастливыми](../analysis/schaste-kak-smysl-zhizni.md#cornerstone_of_text);
- [Жизнь состоит из моментов, и если преобладают счастливые, то её можно назвать Счастливой](../analysis/schaste-kak-smysl-zhizni.md#moments_of_happiness).
...
## Общая Цель <a href="#shared_goal" id="shared_goal"></a>
