...
Пожалуй, могу с уверенностью сказать, что рачительные навыки управления и ведения хозяйства xref:p1-050-country.adoc#russian_management[не являются нашей сильной национальной чертой]!
:-)
...
За сотню лет до церковного раскола на Руси формировались правила хозяйствования, описанные в https://ru.wikipedia.org/wiki/Домострой[Домострое].
И образ этой книги я слышал до недавнего времени исключительно в нарицательном формате как пример мракобесия.
Но после прочтения доклада о https://t.me/sergei_ivanov_efko/3372[хозяйствовании старообрядцев] от автора книги https://www.livelib.ru/book/1013622664-se-chelovek-i-delo-ego-valerij-vsevolodovich-kerov[«Се человек и дело его…»] поменял отношение и взглянул с другой стороны.

Рекомендую прочитать самостоятельно, но основные выводы сделал такие:

- Основная ценность и смысл правил Домостроя был в формировании xref:p2-110-system.adoc#family_priorities[образа семьи как храма и государства], где Труд обозначался как необходимый xref:p2-120-school.adoc#psychology_of_will[Волевой компонент] в процессе xref:p2-120-school.adoc#idealization[Духовного роста].
- Само наличие правил и описание процессов закладывало xref:p2-120-school.adoc#psychology_of_mind[Рациональный фундамент хозяйствования].
Можно проводить аналогии русских традиций с протестантизмом в Европе.
- После церковного раскола в этой xref:p2-110-system.adoc#family_priorities[системе координат] остались преимущественно старообрядцы, которые традиционно вызывали мой интерес.
Они xref:dna[мои предки по отцовской линии] и с ними связано xref:p2-130-local.adoc#old_samara[множество архитектурных памятников в родной Самаре].
Да и общеизвестные фамилии Демидовых, https://www.livelib.ru/quote/48372436-morozovy-dinastiya-metsenatov-lira-muhovitskaya[Морозовых], Мамонтовых, Черепановых, Рябушинских формируют прежде всего ассоциацию с прогрессивным и рациональным управлением, а не с отсталым мракобесием.
...
- А ещё через столетие правила были «прочитаны» Бердяевым не как «духовный рост» с обязательным проявлением xref:p2-120-school.adoc#psychology_of_will[Воли], а как «система подавления духа» с акцентом на xref:p2-120-school.adoc#psychology_of_unconscious[Свободу и Чувства].
- И в результате «выплеснули ребёнка вместе с водой», а наш маятник качнулся в сторону xref:p2-120-school.adoc#psychology_of_unconscious[либеральных свобод], где xref:p2-120-school.adoc#psychology_of_belief[вера] и xref:p2-120-school.adoc#psychology_of_will[волевые навыки] уже были представлены несколько в другом свете.

Помимо собственных наблюдений и анализа особенностей xref:p2-130-local.adoc#old_samara[родного русского окружения], могу сослаться на выступление https://t.me/sergei_ivanov_efko/2027[«Душа России на распутье»], где буквально в первых минутах говорится об исследовании, подтверждающем, что в России чаще встречаются люди, которые ориентируются прежде всего на идеализированные представления, а не на объективные факты и цифры.
В xref:p2-130-local.adoc#love_to_vo[Петербурге], да и по всей стране, таких сильно больше, чем в Москве, например.

Другой причиной формирования преимущественно идеализированных представлений могут быть xref:p1-050-country.adoc#big_size_matters[размеры нашей страны].

На мой взгляд, наши пространства и богатства повлияли на особенности в отношении русских к собственному греху и покаянию.
Со сравнительным анализом российского и западного менталитета в этом контексте можно ознакомиться в https://azbyka.ru/otechnik/Viktor-Zhivov/russkij-greh-i-russkoe-spasenie/[докладе по ссылке].
...
Важно, что у людей с xref:p1-020-call.adoc#mbti_personalities[разными образами мышления] и подходы к управлению будут разные!

И важно разобраться, что нам с этим делать?

Спустя 20 лет после xref:index.adoc#what_to_do[попытки Чернышевского] этим же вопросом 
https://www.livelib.ru/review/5240326-tak-chto-zhe-nam-delat-lev-tolstoj[задался Лев Николаевич Толстой].

А в 2006 году российские политологи https://www.livelib.ru/quote/47030374-strategicheskaya-psihologiya-globalizatsii-psihologiya-chelovecheskogo-kapitala[начали задумываться об объективных метриках]:
...
Тренировался Владимир Ильич на собраниях народовольцев, которые происходили неподалёку от места, xref:p2-130-local.adoc#old_samara[где я живу].
...
И такой количественный подход к своим навыкам и ресурсам неоднократно лежал в основе будущих характеров выдающихся людей – например, https://www.livelib.ru/quote/48237439-lev-tolstoj-svobodnyj-chelovek-pavel-basinskij[Лев Николаевич Толстой постоянно строил таблички с ежедневными показателями своих целей].
...
.Пример
****
Huawei создали https://consumer.huawei.com/ru/wearables/watch-d2/[продвинутые часы для мониторинга давления].
...
Следуя принципу xref:p2-110-system.adoc#paradox[совмещения Природных и Технологических подходов], в жертву было принесено благо цивилизации — личный автомобиль.
...
В летние периоды с огромным удовольствием используя сап и велосипед.
...
Но вот выехал на xref:p2-130-local.adoc#love_to_vo[просторную набережную лейтенанта Шмидта], меня встречает Нева и поток свежего воздуха.
...
. xref:report_products[Достоверные первичные данные];
. xref:p1-030-time.adoc#shared_vision[ChatGPT], который выдавал мне возможные варианты причин повышенных показателей и рекомендации по дальнейшей диагностике в максимально понятном мне формате.

Проверку этих рекомендаций и выписку направлений я доверял специалистам, выбирая из лучших на сайте https://prodoctorov.ru/[ПроДокторов].
...
.Дополнение
****
Спустя 9 месяцев после написания этих строк появился сервис https://app.healz.ai/[HEALZ.AI].
****
...
В своё время очень отозвалась история Тинькова, который не мог заснуть в xref:p1-020-call.adoc#follow_your_calling[следовании собственному Призванию]:

[quote, 'https://www.livelib.ru/quote/2030034-ya-takoj-kak-vse-oleg-tinkov[Олег Тиньков]']
____
...
По https://deep.online/ru/how/[ссылке] можно найти описание, да и уважаемые мной специалисты подтвердили, что определённый эффект должен быть.
...
Пока в мире не наступил коммунизм (на что я не рассчитывал бы в своей жизни), пока деньги играют важнейшую роль — их необходимо контролировать, но xref:p1-040-unhappiness.adoc#money_for_nothing[нельзя на них зацикливаться].

Про финансовую грамотность написаны прекрасные книжки, а кто-то уже xref:your_budget[активно просвещает].
...
[quote, 'https://www.livelib.ru/quote/48372460-morozovy-dinastiya-metsenatov-lira-muhovitskaya[Лира Муховицкая]']
____
...
Отец его невесты, Яков Семёнович Курганов, был простым портным, но строго придерживался xref:p2-110-system.adoc#rational_definition_of_christ[евангельской системы координат].

.Курганов Яков Семёнович
image::kurganov.jpg[Курганов Яков Семёнович,width=50%]

В семейных разговорах за столом мама пересказывала воспоминания своей мамы о том, как Ленин, в его xref:digital_lenin[бытность помощника адвоката в Самаре], заказал пошивку костюма.
...
О чём недавно нашлась запись https://base.memo.ru/person/show/1922550[тут] и https://ru.openlist.wiki/Курганов_Яков_Семенович_(1911)[тут], хоть и с ошибкой в дате рождения.
...
Последний микропроект xref:home[Умного дома] элементарен – панель со сменой фотографий, хранящихся в персональном облаке.
Фоторамка, но сделанная самостоятельно https://github.com/helgeerbe/picframe[на базе Open Source проекта] из бесхозного Raspberry Pi и старого монитора.
...
С появлением российского https://www.genotek.ru/[Генотек] подарил тесты на Новый год дочери и племяннику.
...
Трудно назвать совпадением, что город, xref:p2-130-local.adoc#love_to_vo[ставший самым любимым со школы], спустя 35 лет оказался землёй предков, прописанной в ДНК.

.Происхождение – Санкт-Петербург!
image::baltic.jpg[Происхождение – Санкт-Петербург!, width=50%]
...
Два крестьянина xref:p2-120-school.adoc#psychology_of_belief[помолились] и xref:p2-120-school.adoc#psychology_of_mind[рационально «включили мозги»] – занялись системным решением голода в меру своих возможностей. 
...
Как ни странно, этот https://www.livelib.ru/quote/48253816-lev-tolstoj-svobodnyj-chelovek-pavel-basinskij[сезонный голод был обратной стороной освобождения крестьян].
...
Даже xref:p1-010-happiness.adoc#happiness_model[умеренный алкоголь вгоняет меня на пару дней в яму эмоционального тона, что интеграл становится отрицательным].
Таким же особенно разрушительным образом действуют быстрые углеводы.

Но зато повезло с xref:p1-020-call.adoc#architect_personality[выдающимися способностями в ДНК и они совпадают с психотипом]:
...
* Особенное внимание правильному произношению – ну точно xref:index.adoc#introduction[душнила].
...
Рациональному порыву оцифровки знаний о любимой эмоциональной музыке xref:p2-150-absurd.adoc[посвятил отдельную главу].
...
Уверен, что разработчики Кинопоиска тоже вдохновлялись IMDB и сделали свою платформу, которая в чём-то была удобнее, но также учитывала xref:why_digital_russia[русский менталитет] в восприятии фильмов и при составлении рейтингов.
...
При том, что искренне считаю – xref:p2-120-school.adoc#psychology_of_unconscious[настоящее искусство за рамками рациональных правил и границ].
Как быть?
...
_Автор текста: (xref:p2-100-authors.adoc#zpss[Сергей Сергеевич Поляков])_
