...
Они подробно описаны в https://www.livelib.ru/review/3871987-the-samarsky-yard-samarskij-dvor[книге «Самарский двор»].
...
И почему-то думал тогда, начитавшись xref:p1-020-call.adoc#thinking_feeling[Шёрлока Холмса], что Лондон — это Питер на стероидах.
...
Мне нравится думать, что место проживания я выбирал прежде всего из ощущения близости к https://ru.wikipedia.org/wiki/Бой_в_устье_Невы[месту чудесного «Небываемое бывает» рождения Российского флота], чем по другим рациональным соображениям.

Каждый раз, отправляясь из дома в город, я прохожу мимо…

Горного института, где формировалась основа богатства России и xref:p2-110-system.adoc#family_priorities[старообрядец Черепанов изобретал паровые механизмы].

Казарм лейб-гвардии Финляндского полка, 11 военнослужащих нижних чинов которого отправил на тот свет xref:index.adoc#what_to_do[революционер Халтурин в борьбе за осчастливливание русского народа].

Дома семьи Рериха, давшего нам знак «Знамени мира», который поразительно напоминает xref:p2-110-system.adoc#human_as_god[«Троицу»] Рублёва и xref:p2-120-school.adoc#happiness_in_school[олицетворяет 3 опоры для достижения состояния благополучия].
...
Понятие https://ru.wikipedia.org/wiki/Философский_пароход[«Философский пароход»] ввёл в 1990-м году Сергей Хоружий.
Его работы были использованы при написании xref:p2-120-school.adoc#human_capital_book[«Психологии Человеческого Капитала»].
Он также повлиял на xref:p2-120-school.adoc#saints_in_russia[определение высшего уровня в «Количественной модели счастья»].
...
Вероятно, что именно в этом доме в 30-е годы василеостровец Михаил Зощенко встречался со знаменитым профессором для того, чтобы https://www.livelib.ru/review/5058298-pered-voshodom-solntsa-mihail-zoschenko[осмыслить причины своей депрессии в книге], которая станет причиной его гонений.

Васильевский остров задумывался Петром как центр города, а город как центр мира.
Трезини, определявший облик Петербурга, построил тут свой дом, с которого начинается каменная ступенчатая застройка, ставшая https://ru.wikipedia.org/wiki/Набережная_Лейтенанта_Шмидта_(Санкт-Петербург)[эталонной набережной], по которой стараюсь проходить как можно чаще.
...
Как и для автора автобиографической повести https://www.livelib.ru/book/1006147069-sestra-pechali-vadim-shefner[«Сестра Печали»].

[quote, 'http://a-pesni.org/dvor/piter/a-izzapisn.php[Вадим Шефнер]']
____
...
Первым делом https://ru.ruwiki.ru/wiki/Цифровой_Петербург[подписали партнёрские соглашения с Яндексом и ВКонтакте] – чтобы создавать сообща и не делать лишнюю работу.
...
В результате затраты на одного из самых известных и дорогих гидов Санкт-Петербурга — https://vk.com/spbtrip[Павла Перца], отбились и ещё осталось на https://vk.com/bongiozzo?w=wall20069794_96[обсуждение услышанного в местном ресторанчике].
...
[quote, 'https://www.livelib.ru/quote/431589-tyazhelyj-pesok-anatolij-rybakov[Анатолий Рыбаков]']
____
...
Когда отдаёшь себе отчет, что внутри xref:p2-110-system.adoc[достаточно твердая собственная опора из системы ценностей] и xref:p1-040-unhappiness.adoc#battery_aziz[хватает батарейки] улучшать мир вокруг — иди и делай бестрепетно.
...
«Люби свой город не только на словах!» — как говорят xref:#tom_sawyer_fest[участники Том Сойер феста].
