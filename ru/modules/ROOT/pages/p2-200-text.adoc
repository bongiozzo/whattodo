...
Все эти возможности должны быть абсолютно xref:p2-170-opensource.adoc[открытыми и бесплатными].
...
xref:index.adoc#text_is_not_a_book[Наш Текст – это же не книга].
